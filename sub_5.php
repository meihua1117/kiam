...
<?
	...
	$sql = "select sum(add_phone) add_phone from tjd_pay_result where buyer_id = '{$_SESSION['one_member_id']}' and end_date > '$date_today'  and end_status in ('Y','A') order by no desc limit 1";
	$res_result = mysqli_query($self_con, $sql);
	//결제 휴대폰 수
												...
												<div class="info_box">
													<table class="info_box_table" cellpadding="0" cellspacing="0">
														<tbody>
															...
															<tr>
																<th>통신사</th>
																<td><select id="detail_company" name="detail_company">
