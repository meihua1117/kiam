                    ...
                    <div class="box-body">
                        <table id="detail1" class="table table-bordered table-striped">
                            <tbody>
                                <tr>
                                    <th>
                                        <input type='button' style="background-color:blue;color:white;" value='아이엠정보' />
                                    </th>
                                    <td colspan="2">
                                        <h5 style="width:280px;">※아래 항목에 아이엠정보를 입력하면 이용자의 아이엠에 여기에 입력한 정보가 해당 회원의 아이엠 디폴트로 나타납니다. 해당 정보는 관리자가 직접 입력, 수정할수 있습니다. </h5>
                                    </td>
                                </tr>
