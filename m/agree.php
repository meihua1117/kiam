			...
			<div class="container">
				<div class="row">
					<div class="col-12">
                        ...
                        <img src="img/guide.png" style="margin-bottom:10px">


							<h1 class="title">약관동의</h1>
            <div class="right_sub_menu" style="float:right">
		       <button type="button" style="background:#D8D8D8">
                <a href="/sub_13.php">마이샵이용안내보기</a> </button>
            </div> <br>
...
※마이샵접속안내<br>
1. 이용 절차를 알고 싶다면 상단의 [마이샵이용안내보기]를 다시 [마이샵이용]접속하세요.<br>
...
3. 마이샵으로 연동이 끝나면 부족한 정보를 채우시기바랍니다.
                                ...
                                <div class="button-wrap">
    								...
    								<a href="http://obmms.aplat.kr/api.php?id=<?php echo $_SESSION[one_member_id]?>" class="button  is-grey">이용하기</a>
    							</div>
