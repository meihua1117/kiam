            ...
            <div class="col-12">
                <div class="inner-wrap">
                    <div style="float:right">
                        <div>
                            <?php include $_SERVER['DOCUMENT_ROOT']. "/mypage_base_navi1.php";?>
                        </div>
                    </div>
                    <br>
                    <br>
                        ...
                        <section class="input-field">
                            ...
                            <div class="form-wrap">
                                ...
                                <div class="attr-row is-phone">
                                    ...
                                    <div class="attr-value">
                                        <div class="input-wrap">
                                            <input type="text" class="input"  name="name"  id="name" value="<?php echo $member_1['mem_name'];?>">
                                            <div class="check-wrap">
                                                <input type="checkbox" class="check" id="mem_sex_m" name="mem_sex" value="m" <?php echo $member_1['mem_sex']=="m"?"checked":"";?>>
                                                <label for="mem_sex_m">남자</label>
                                            </div>
                                            <div class="check-wrap">
                                                <input type="checkbox" class="check"  id="mem_sex_f" name="mem_sex" value="f" <?php echo $member_1['mem_sex']=="f"?"checked":"";?>>
                                ...
                                <div class="attr-row">
                                    ...
                                    <div class="attr-value">
                                        <div class="input-wrap">
                                            <input type="text" name="zy" id="zy" class="input" placeholder="회사명, 단체명, 직장명" value="<?php echo $member_1['zy'];?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="attr-row">
                                ...
                                <div class="attr-row is-account">
                                    <div class="attr-name">일반전화</div>
                                    <div class="attr-value">
                                        <div class="input-wrap">
                                            <?php echo $member_1['mem_tel'];?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="attr-row is-mail">
                                    ...
                                    <div class="attr-value">
                                        <div class="input-wrap">
                                            <input type="text" style="width:135px" class="input mail-first" name="email_1" required itemname='이메일' id="email_1" value="<?php echo $m_email_arr[0]; ?>">
                                            <span class="bridge">@</span>
                                            <input type="text" style="width:calc( 100% - 235px );"  class="input mail-second" name="email_2" id='email_2' itemname='이메일' required  value="<?php echo $m_email_arr[1];?>">
