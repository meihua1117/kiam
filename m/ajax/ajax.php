...
if($_POST[id] && $_POST[pwd])
{
	...
	if($_POST[join_modify] == "") {
	    ...
	    if($_POST['rnum'] != "") {
            ...
            if($data[idx] == "") {
	        ?>
	            <script language="javascript">alert('인증번호를 확인해주세요....');</script>
	        <?
	        exit;
	        }
	    }
	...
	if(strstr($sql, "update") == true && $_POST[join_modify] == "") $sql.=" where mem_code='$_POST[join_modify]' ";
