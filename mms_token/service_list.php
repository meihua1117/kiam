...
if(!$token || !check_token($phone_num, $token)){
    echo json_encode(array("result"=>-1,"data"=>"","token_res"=>0));
}
else{
    //로그인 id pw
