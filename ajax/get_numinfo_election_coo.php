...
echo json_encode(array("detail_name"=>$detail_name,
						"phoneno"=>$pno,
						...
						"excelDownload2"=>$excelDownload2,
						"todaySendCnt"=>$todaySendCnt,
						"cnt2State"=>$cnt2State,
						"diviceModel"=>$diviceModel,
						"detail_rate"=>$donation_rate,
						"thismonthCnt"=>$thismonthCnt,
						"lastSendDate"=>$lastSendDate,
						"syncDbdate"=>$syncDbdate,
						"daily_limit_cnt"=>$daily_limit_cnt,
						"daily_min_cnt"=>$daily_min_cnt,
						"monthly_receive_cnt"=>$monthly_receive_cnt,
						"daily_limit_cnt_user"=>$daily_limit_cnt_user,
						"daily_min_cnt_user"=>$daily_min_cnt_user,
						"monthly_receive_cnt_user"=>$monthly_receive_cnt_user));
?>