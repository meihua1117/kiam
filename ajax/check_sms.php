...
if(!preg_match('/(01[016789])([0-9]{3,4})([0-9]{4})/', $_POST['rphone']) && !preg_match('/(01[016789])-([0-9]{3,4})-([0-9]{4})/', $_POST['rphone'])){
    echo '{"result":"fail","msg":"폰 번호를 정확히 입력해 주세요."}';
    exit;
}
...
if($mode == "send_sms") {
    ...
    echo '{"result":"fail", "msg":"Invalid request"}';
    exit;
}
