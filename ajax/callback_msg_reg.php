...
mysql_query($sql_update_callback) or die(mysql_error());

$sql_callback_msg = "update gn_mms_callback set regdate=now() where idx={$callback_no}";
mysql_query( $sql_callback_msg) or die(mysql_error());
...
if ($row_chk['mb_id'] != "") {
    ...
    mysql_query( $sql_callback) or die(mysql_error());
}
...
mysql_query( $sql_point_update) or die(mysql_error());
