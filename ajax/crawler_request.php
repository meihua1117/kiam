...
$term = date("Y-m-d", strtotime("next Year"));
        ...
        $sql="insert into crawler_request set mem_id='{$_SESSION['one_member_id']}', regdate=NOW()";
        ...
        if($row['mem_id'] == "") {
            $result = "fail";
            echo json_encode(array("result"=>$result,"msg"=>"없는 회원 아이디 입니다."));
            exit;            
        }
        
    
        //$addSql .= " ,`password`='$row['mem_leb']'";
