...
$sql_insert = "insert into Gn_Item_Pay_Result set buyer_id='{$mem_id1}', buyer_tel='{$row_memdata['mem_phone']}', item_name='데일리메시지', item_price={$min_point}, pay_percent=90, current_point={$point}-{$min_point}, current_cash='{$cash}', pay_status='Y', VACT_InputName='{$row_memdata['mem_name']}', type='use', pay_method='{$method}', pay_date=now(), point_val=1,billdate=now()";
