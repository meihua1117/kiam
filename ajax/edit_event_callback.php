...
if (isset($_POST['edit_ev'])) {
  ...
  $res_call_id = mysql_query( $sql_call_id);
  $row_call_id = mysql_fetch_array($res_call_id);
  ...
  while ($row = mysql_fetch_array($res)) {
    ...
    while ($row_sel_mem = mysql_fetch_array($res_sel_mem)) {
    ...
    $res_unsel_mem = mysql_query( $sql_unsel_mem);
    while ($row_unsel_mem = mysql_fetch_array($res_unsel_mem)) {
