								...
								<div class="div_240">
									...
									<div class="a2">
										...
										<div class="b2">
											...
											<div class="div_2px">
											<input type="file" name="upimage" onChange="onUploadImgChange(this);sub_4_form.action='up_image.php?i=0';sub_4_form.target='excel_iframe';sub_4_form.submit();" /></div>
			...
			<div class="info_text">
				...
				case 6:
					...
					<div class="sub_4_4_t1">
                        <div class="sub_4_4_t2">
                         <div class="sub_4_1_t3">
                    <a href="sub_4.php?status=<?php echo $_GET['status'];?>&status1=1"style="color:#000":">수신거부</a> &nbsp; | &nbsp; 
