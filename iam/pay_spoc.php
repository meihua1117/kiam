...
<script>
    if("<?=$platform?>" != "mobile" && navigator.userAgent.toLocaleLowerCase().search("android") > -1) {
        location.href = "?platform=mobile&totprice=" + '<?=$totprice?>'+'&itemname=' + '<?=$itemname?>';
    }
</script>
<?
                            ...
                            <div  style="text-align: center;border: 2px solid;border-color: #cfcfcf">
                                ...
                                <div style="padding-top: 30px">
                                    <div style="display: flex;padding: 10px">
                                        ...
                                        <div><input type="text" name="item_name" id="item_name" value="<?=$item_name?>" style="border-radius: 5px;line-height: 20px;text-align: center;margin-left: 14px" readonly></div>
                                    </div>
                                </div>
