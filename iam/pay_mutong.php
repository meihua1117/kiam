...
<form name="pay_form" id="pay_form" method="post"> <!--승인요청 및 결과수신페이지 지정 //-->
    ...
    <!--상품명-->
    <input type="hidden" name="allat_product_nm" id="allat_product_nm" value="<?=$_POST[allat_product_nm]?>" size="19" maxlength=1000>
    <!--결제자성명-->
    <input type="hidden" name="allat_buyer_nm" value="<?php echo $member_iam['mem_name'];?>" size="19" maxlength=20>
    <!--수취인성명-->
    <input type="hidden" name="allat_recp_nm" value="<?php echo $member_iam['mem_name'];?>" size="19" maxlength=20>
    <!--수취인주소-->
    ...
    <div class="big_main pay-wrap" style="height: auto;min-height: 100%;">
        <div id="wrap" class="common-wrap" background-image = "/images/main_bg_09.jpg" style="max-width: 1024px;padding:0px">
            ...
            <div class="pay" style="padding: 20px;background-color: #FFF;">
            ...
            <div class="modal-body">
                <div class="container" style="margin-top: 20px;text-align: center;width:100%">
                    <form method="post" id="dForm" name="dForm" action="/admin/ajax/service_Iam_save.php"  enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="my_card_cnt" id="my_card_cnt" value="2" >
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <th>분양자아이디</th>
                                    <td > <input type="text" style="width:100%;" name="mem_id" id="mem_id" value="<?=$member_iam['mem_id']?>" >  </td>
                                </tr>
                                <tr>
                                    <th>분양자이름</th>
                                    <td >  <input type="text" style="width:100%;" name="mem_name" id="mem_name" value="<?=$member_iam['mem_name']?>" >  </td>
                                </tr>
                                <tr>
                                    <th>업체대표이름</th>
                                    <td> <input type="text" style="width:100%;" name="owner_name" id="owner_name" value="<?=$member_iam['mem_name']?>" > </td>
                                </tr>
                                <tr>
                                    <th>관리자이름</th>
                                    <td> <input type="text" style="width:100%;" name="manager_name" id="manager_name" value="<?=$member_iam['mem_name']?>" > </td>
                                </tr>
                                <tr>
                                    <th>업체이름</th>
