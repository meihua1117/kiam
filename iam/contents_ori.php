						...
						<div class="media-inner" <?if($meta_row['contents_type'] == 1 && count($content_images) == 0) echo "style = 'min-height :30px'";?>>
							<div class="user-item">
								...
								<div class="dropdown" style="position: absolute; right: 10px; top: 8px;">
									<button class="btn-link dropdown-toggle westory_dropdown" type="button" onclick="window.close();">
											...
											<div class="outer <?=$row_card[sale_cnt_set]?>">
												...
												<?}else{
													...
													<div class="price" style="width:230px;">    
														...
														<span class="downer" style="color:blue;">공급가:<?=number_format($meta_row['send_provide_price'])?>원 <span style="vertical-align: top;color: red;margin-left: 10px;font-weight: bold;"><?=(int)$discount?>%</span></span>
														<?}
														else{?> -->
					...
					<div class="info-wrap" style="border:none">
						...
						<div class="second-box">
							...
							<div class="in-box" style="position: absolute;right: 10px;">
								...
								<a class="gwc_order_btn1" href="javascript:show_order_option('<?=$meta_row[idx]?>', 'cart')" style="margin-top: 5px;font-size: 12px;border: 1px solid #82c836;margin-right: 10px;padding: 3px 10px;border-radius: 10px;">장바구니</a>
								<a class="gwc_order_btn2" href="javascript:show_order_option('<?=$meta_row[idx]?>', 'pay')" style="margin-top: 5px;font-size: 12px;padding: 3px 10px;border-radius: 10px;border: 1px solid;color: white;background-color: #82c836;">바로구매</a>
							</div>
							<?}?>
						</div>
					</div>
