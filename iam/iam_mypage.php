            ...
            <div class="col-12">
                <div class="inner-wrap">
                    ...
                    <form name="join_form" id="join_form" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="join_modify" value="<?= $data['mem_code'] ?>">
                        <input type="hidden" name="id" value="<?= $data['mem_id'] ?>">
                        <input type="hidden" name="pwd" value="<?= $data['mem_id'] ?>">
                        <section class="input-field">
                            ...
                            <div class="form-wrap">
                                ...
                                <div class="attr-row is-phone">
                                    ...
                                    <div class="attr-value">
                                        <div class="input-wrap">
                                            <input type="text" class="input" name="name" id="name" value="<?= $data['mem_name']; ?>">
                                            <div class="check-wrap">
                                                <input type="checkbox" class="check" id="mem_sex_m" name="mem_sex" value="m" <?= $data['mem_sex'] == "m" ? "checked" : ""; ?>>
                                                <label for="mem_sex_m">남자</label>
                                            </div>
                                            <div class="check-wrap">
                                                <input type="checkbox" class="check" id="mem_sex_f" name="mem_sex" value="f" <?= $data['mem_sex'] == "f" ? "checked" : ""; ?>>
                                ...
                                <div class="attr-row">
                                    ...
                                    <div class="attr-value">
                                        <div class="input-wrap">
                                            <input type="file" name="profile" id="profile" itemname='사진' /><?php if ($member_iam['profile'] != "") {
                                ...
                                <div class="attr-row">
                                    ...
                                    <div class="attr-value">
                                        <div class="input-wrap">
                                            <input type="text" name="zy" id="zy" class="input" placeholder="회사명, 단체명, 직장명" value="<?= $data['zy']; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="attr-row">
                                    ...
                                    <div class="attr-value">
                                        <div class="input-wrap">
                                            <input type="text" name="add1" id="add1" required class="input" itemname="회사/단체, 직장 주소입력" placeholder="회사/단체, 직장 주소입력" value="<?= $data['mem_add1']; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="attr-row is-mail">
                                    ...
                                    <div class="attr-value">
                                        <div class="input-wrap">
                                            <input type="text" style="width:135px" class="input mail-first" name="email_1" required itemname='이메일' id="email_1" value="<?= $email[0]; ?>">
                                            <span class="bridge">@</span>
                                            <input type="text" style="width:calc( 100% - 235px );" class="input mail-second" name="email_2" id='email_2' itemname='이메일' required value="<?= $email[1]; ?>">
                        ...
                        <div class="desc-wrap">
                            <div class="inner">
                                <ul>
                                    ...
                                    <li>④  회원탈퇴시 원스텝솔루션의 수신동의자 정보와 랜딩정보, 예약메시지정보를 모두 사용할 수 없게 됩니다. </li>
