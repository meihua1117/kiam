...
<div class="big_main" style="margin-top:86px">
    <div class="m_div">
        ...
        <div style="padding: 20px;background-color: #FFF;">      		
            <table style="border-bottom: 1px solid #CCC;border-right: 1px solid #CCC;" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                ...
                PG log</td>
                    ...
                    <p style="font-size:15px;font-weight:bold">입금예정시간내로 아래 계좌로 입금하시면 구매가 완료됩니다.</p><br/> 
                    -스텐다드차타드은행 617-20-109431 온리원연구소-(구,SC제일은행) </td>
                    </tr>
                <tr>
