    ...
    <div class="big_main pay-wrap" style="height: auto;min-height: 100%;background:white;margin-bottom: 50px;">
        <div id="wrap" class="common-wrap" style="max-width: 1024px;padding:0px">
            <div style="margin-top: 58px;text-align:center">
                <div style="font-size:24px;font-weight:bold;margin-bottom:10px">IAM이용료 안내</div>
                <div style="font-size:16px;margin-bottom:10px">비즈니스 성공 지원툴의 혁신적인 요금제를 선택해 보세요.</div>
            </div>
            <div style="text-align: center">
                <button class = "btn exp-tab pay_tab" style="width:200px;height:60px" onclick="activeTab(1)">서비스 설명</button>
                <button class = "btn cost-tab pay_tab active" style="width:200px;height:60px" onclick="activeTab(2)">가격정보</button>
                <button class = "btn cancel-tab pay_tab" style="width:200px;height:60px" onclick="activeTab(3)">취소,환불규정</button>
            <div>
            ...
            <div class="modal-dialog" style="width: 100%;max-width:768px;">
                ...
                <div class="modal-content" >
                    ...
                    <div class="modal-footer" style="display:flex">
                        <button type="button" class="btn btn-default btn-submit" style="margin-left:auto;margin-right:auto;border-radius: 5px;width:40%;font-size:15px;background: #82c736;color: white" onclick="pay(document.pay_form)">잘 확인했습니다</button>
