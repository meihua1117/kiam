...
if(isset($_POST['send_id']) && isset($_POST['receive_id'])){
    ...
    $result_mem = mysql_query($sql_chk_mem);
    ...
    $resul_send=mysql_query($sql_send);
    $data_send=mysql_fetch_array($resul_send);
    ...
    $resul_recv=mysql_query($sql_recv);
    $data_recv=mysql_fetch_array($resul_recv);
