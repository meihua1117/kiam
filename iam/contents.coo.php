							...
							<div class="desc is-product">
								<div class="desc-inner">
									<div class="outer">
										...
										<span
											class="downer"><?=number_format($meta_row['contents_sell_price'])?>원</span>
										</div>
										<div class="order">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="center_text">
						...
						<div class="sns_item" onclick="contents_copyContacts()"><div class="sns_icon_div"><img class="sns_icon" src = "img/sns_icon4.png"></div><div class="sns_item_text" >아이엠<br>주소복사</div></div>
					</div>
				</div>
			</div>
		</div>
