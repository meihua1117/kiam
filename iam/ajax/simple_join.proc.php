...
if ($mode == "join") {
  ...
  if ($row['mem_id']) {
    ...
    $sql2 = "insert into Gn_Member (mem_leb, mem_id, mem_pass, web_pwd, mem_phone, first_regist, join_ip, iam_leb) values ('22', '$id_che', '$mem_pass', md5('$mem_id'), '$simple_phone', now(), '$ip', 1)";
