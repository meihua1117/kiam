...
$cont_order = $_GET['cont_order_type'];
...
if ($cont_count == 0) {
    ...
    foreach ($cont_array as $contents_row) {
        ...
        $user_display = "";
        if ($contents_row['contents_user_display'] == "N") {
        ...
        if ($_GET['iamstore'] != 'N' || $_GET['cate_prod'] == '1268514') {
            $body .=     "<a href=\"/?" . strip_tags($contents_row['westory_card_url'] . $m_code) . "\" class=\"date\" >" .
        ...
        if ($_SESSION['iam_member_id'] == $contents_owner_id && $_SESSION['iam_member_id'] != 'iamstore' && $contents_row['ai_map_gmarket'] == 3 && $contents_row['provider_req_prod'] == "N") {
            $body .=    "<div class=\"dropdown\" style=\"position: absolute; right: 10px; top: 8px;\">" .
                "<button class=\"btn-link dropdown-toggle westory_dropdown\" type=\"button\" data-toggle=\"dropdown\" >" .
                "<img src=\"/iam/img/menu/icon_dot.png\" style=\"height:24px\">" .
                "</button>" .
        ...
        if ($_SESSION['iam_member_id'] == "") {
            $body .=    "<div class=\"dropdown \" style=\"position: absolute; right: 10px; top: 8px;\">" .
                ...
                "</button>" .
                "<ul class=\"dropdown-menu comunity\">" .
                "<li><a onclick=\"location.href='/iam/join.php'\">나도 아이엠 만들고 싶어요</a></li>" .
                "<li><a onclick=\"window.open('/?" . strip_tags($contents_row['westory_card_url'] . $_SESSION['recommender_code']) . "');\">이 콘텐츠 게시자 보기</a></li>" .
                "<li><a onclick=\"window.open('/?" . $contents_row['westory_card_url'] . $_SESSION['recommender_code'] . "&cur_win=my_story')\" >더 많은 콘텐츠 보러가기</a></li>" .
        ...
        if (count($content_images) > 0 || $contents_row['contents_url'] != "") {
            ...
            if ($content_images != null) {
                $body .=        "<a onclick=\"show_contents_utils(" . $contents_row['idx'] . ");\" class=\"content-utils\"" .
                    ...
                    "</a>" .
                    "<div class = \"utils-index\" id=\"utils_index_" . $contents_row['idx'] . "\" style=\"display:none;flex-direction: column;z-index:10;top:14px;right:43px;\">" .
                    "<div>";
                $body .=                "<a class=\"content-utils\" onclick=\"remove_shared_content('" . $contents_row['idx'] . "','" . $_SESSION['iam_member_id'] . "');\" style=\"\">" .
                    "<img src=\"/iam/img/menu/icon_utils_hide.png\"  style=\"\">" .
                    "</a>" .
        ...
        $body .= "<div class=\"desc-wrap\" style=\"padding:5px 6px;\">" .
            ...
            "<p style=\"overflow-wrap: break-word;font-size: 14px;font-weight:400\">" . nl2br($contents_row['contents_desc']) . "</p>" .
            "</div>";
        if ($content_images == null) {
            if ($cur_card['share_send_card'] != 0 || $_SESSION['iam_member_id'] != $contents_row['mem_id']) {
                ...
                $body .=            "<a onclick=\"show_contents_utils(" . $contents_row['idx'] . ");\" class=\"content-utils\"" .
                    ...
                    "<img src = \"/iam/img/menu/icon_utils_box.png\" >" .
                    "</a>" .
                    "<div class = \"utils-index\" id=\"utils_index_" . $contents_row['idx'] . "\" style=\"display:none;flex-direction: column;z-index:10;top:5px;right:43px;\">" .
                    "<div>";
                $body .=                    "<a class=\"content-utils\" onclick=\"remove_shared_content('" . $contents_row['idx'] . "','" . $_SESSION['iam_member_id'] . "');\" style=\"\">" .
                    "<img src=\"/iam/img/menu/icon_utils_hide.png\"  style=\"\">" .
                    "</a>" .
