...
while($post_row = mysql_fetch_array($post_res)) {
	...
	while($reply_row = mysql_fetch_array($reply_res)){
		...
		$res_mem_r = mysql_query($sql_mem_r);
		$row_mem_r = mysql_fetch_array($res_mem_r);
		...
		$reply_card_res = mysql_query($reply_card_sql);
		$reply_card_row = mysql_fetch_array($reply_card_res);
