...
<?
    ...
    if($type == "address"){
        ...
        $res_contents_data = mysql_query($sql_contents_data);
        
        while($row_contents_data = mysql_fetch_array($res_contents_data)){
            $sql_card_redu_val = "select add_fixed_val from Gn_Iam_Name_Card where idx='{$card_idx}'";
            $res_card_redu_val = mysql_query($sql_card_redu_val);
            $row_card_redu_val = mysql_fetch_array($res_card_redu_val);
        ...
        $res_mem_code = mysql_query($sql_mem_code);
        $row_mem_code = mysql_fetch_array($res_mem_code);
