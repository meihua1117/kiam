...
<?php include_once "mypage_step_navi.php";?>
   ...
   <div class="m_div">
       ...
       <div class="m_body">
		...
		<li style="float:left;">		
			<div class="popup_holder popup_text">신청고객 수동추가
				<div id="_popupbox"  height: 75px;width: 260px;left: 160px;top: -37px;display:none ;">자신의 이벤트 상품이나 서비스를 소개하거나 상세페이지로 만든 랜딩페이지를 리스트로 보는 기능입니다.<br><br>
