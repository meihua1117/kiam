...
$sql = "select * from Gn_event where event_idx='{$data['event_idx']}' order by event_idx desc";
	...
	<div class="m_div">
		...
		<div class="m_body">
			...
			<form name="sform" id="sform" action="mypage.proc.php" method="post" enctype="multipart/form-data">
				<input type="hidden" name="mode" value="<?= $_REQUEST['request_idx'] != "" ? "request_updat" : "request_add" ?>" />
				<input type="hidden" name="request_idx" value="<?= $request_idx; ?>" />
				<input type="hidden" name="org_event_code" value="<?= $event_data['sp']; ?>" />
