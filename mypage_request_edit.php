	...
	<div class="m_div">
		...
		<div class="m_body">
			...
			<form name="sform" id="sform" action="mypage.proc.php" method="post" enctype="multipart/form-data">
				<input type="hidden" name="mode" value="<?= $_REQUEST['request_idx'] != "" ? "request_update" : "request_add" ?>" />
				<input type="hidden" name="request_idx" value="<?= $request_idx; ?>" />
				<input type="hidden" name="org_event_code" value="<?= $row['sp']; ?>" />
				<input type="hidden" name="event_idx" id="event_idx" value="<?= $event_data['event_idx']; ?>" />
				...
				<div class="p1">
					<table class="list_table1" width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<th class="w200">성별</th>
							<td>
								<input type="radio" name="sex" value="m" <?= $data['sex'] == "m" ? "checked" : "" ?>> 남
								<input type="radio" name="sex" value="f" <?= $data['sex'] == "f" ? "checked" : "" ?>> 여
							</td>
						</tr>
						<tr>
						...
						<tr>
							<th class="w200">직업</th>
							<td>
								<input type="text" name="job" placeholder="" id="job" value="<?= $data['job'] ?>" />
							</td>
						</tr>
						<tr>
							<th class="w200">주소</th>
						...
						<tr>
							...
							<td>
								<input type="text" name="sp" readonly placeholder="" id="event_name_eng" value="<?= $event_data['event_name_eng'] ?>" /> <input type="button" value="신청그룹 조회" class="button " id="searchBtn">
							</td>
						</tr>
						<tr>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<!--input type="text" id="send_time_min" name="send_time_min" value="" style="width:70px;" maxlength="2"> 분 (10분단위로 설정가능)-->$_COOKIE<select name="send_time_min" id="send_time_min" style="width:70px;">
