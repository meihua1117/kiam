...
<body>
    ...
    <form name="group_detail_form" action="" method="post">
        ...
        <table class="list_table" width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td style="width:20%;"><a href="javascript:void(0)" onclick="order_sort(group_detail_form,'grp_2',group_detail_form.order_status.value)">소그룹명<? if ($_REQUEST['order_name'] == "grp_2") {
                ...
                <td style="width:20%;">
                    ...
                    <li style="font-size:13px;font-family:Nanum Gothic;">
                        ...
                        <a href="javascript:order_sort(group_detail_form,'name',group_detail_form.order_status.value)">이름<? if ($_REQUEST['order_name'] == "name") {
                                                                                                                                echo $_REQUEST['order_status'] == "desc" ? '▼' : '▲';
                                                                                                                            } else {
                                                                                                                                echo '▼';
                                                                                                                            } ?></a>
