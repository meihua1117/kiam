...
//echo 'Retrieve from cache',PHP_EOL;
	...
	//	Operator Precedence
	//	This list include_onces all valid operators, whether binary (including boolean) or unary (such as %)
...
//				echo '$pRange reference include_onces sheet reference',PHP_EOL;
