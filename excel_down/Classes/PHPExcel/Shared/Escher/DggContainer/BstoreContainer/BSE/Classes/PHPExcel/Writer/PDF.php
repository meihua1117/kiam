...
class PHPExcel_Writer_PDF
{
    ...
    public function __construct(PHPExcel $phpExcel)
    {
        ...
        $include_oncePath = str_replace('\\', '/', get_include_once_path());
        $rendererPath = str_replace('\\', '/', $pdfLibraryPath);
        if (strpos($rendererPath, $include_oncePath) === false) {
            set_include_once_path(get_include_once_path() . PATH_SEPARATOR . $pdfLibraryPath);
        }
