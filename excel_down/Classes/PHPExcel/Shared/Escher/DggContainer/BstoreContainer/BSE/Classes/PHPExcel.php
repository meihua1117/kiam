...
//if (INSITER_INCLUDE !== 'YES' || $user_info['user_level'] == '' || $user_info['user_level'] > $GLOBALS['site_config']['admin_level']) die('permission error.');
...
class PHPExcel
{
	...
	*/
	...
	/**
	* _macrosCode : all macros code (the vbaProject.bin file, this include_once form, code,  etc.), NULL if no macro
	*
	* @var binary
	*/
