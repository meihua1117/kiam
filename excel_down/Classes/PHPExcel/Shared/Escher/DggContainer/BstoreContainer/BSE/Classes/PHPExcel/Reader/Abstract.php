...
abstract class PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
	 ...
	 * @var	boolean
	 */
	protected $_include_onceCharts = FALSE;
	 ...
	 *		If this is true, then the Reader will include_once any charts that exist in the workbook.
	...
	public function getIncludeCharts() {
		return $this->_include_onceCharts;
	}

	/**
	 * Set read charts in workbook
	 *		Set to true, to advise the Reader to include_once any charts that exist in the workbook.
	 *      Note that a ReadDataOnly value of false overrides, and charts won't be read regardless of the IncludeCharts value.
	...
	public function setIncludeCharts($pValue = FALSE) {
		$this->_include_onceCharts = (boolean) $pValue;
		return $this;
	}
