...
class PHPExcel_Writer_Excel2007_Worksheet extends PHPExcel_Writer_Excel2007_WriterPart
{
	 ...
	 * @param	boolean					$include_onceCharts	Flag indicating if we should write charts
	 * @return	string					XML Output
	 * @throws	PHPExcel_Writer_Exception
	 */
	public function writeWorksheet($pSheet = null, $pStringTable = null, $include_onceCharts = FALSE)
	{
		if (!is_null($pSheet)) {
			// Create XML writer
			$objWriter = null;
			...
			$objWriter->writeAttribute('xmlns:r', 'http://schemas.openxmlformats.org/officeDocument/2006/relationships');
				...
				$this->_writeDrawings($objWriter, $pSheet, $include_onceCharts);
...
//								$calculatedValue = $pCell->getCalculatedValue();
	 ...
	 * @param	PHPExcel_Shared_XMLWriter	$objWriter		XML Writer
	 * @param	PHPExcel_Worksheet			$pSheet			Worksheet
	 * @param	boolean						$include_onceCharts	Flag indicating if we should include_once drawing details for charts
	 * @throws	PHPExcel_Writer_Exception
	 */
	private function _writeDrawings(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null, $include_onceCharts = FALSE)
	{
		$chartCount = ($include_onceCharts) ? $pSheet->getChartCollection()->count() : 0;
