			...
			<div class="m_body">
				<form name="pay_form" action="" method="post" class="my_pay">
					...
					<div class="a1" style="margin-top:15px; margin-bottom:15px">
						<li style="float:left;">퍼널메시지 예약발송리스트</li>
					...
					<div>
						<div class="p1">
							...
							<div style="text-align:right;margin-top:0px;float:right">
								<input type="button" value="예약메시지입력하기" class="button" onclick="location='mypage_reservation_create.php'">
								<input type="button" value="신청고객예약관리" class="button" onclick="location='mypage_request_list.php'">
								<input type="button" value="기존고객예약관리" class="button" onclick="location='mypage_oldrequest_list.php'">
