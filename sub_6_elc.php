...
$res_data = mysql_query($sql_get_data);
							...
							<div class="div_240">
								...
								<div class="a2">
									...
									<div class="div_2px">
										...
										<input type="file" id="img_file3" name="upimage2" onChange="onUploadImgChange(this);sub_4_form.action='up_image_.php?i=0&k=2&target=upimage_str2';sub_4_form.target='excel_iframe';sub_4_form.submit();" value="<?=$row_data['jpg2']?>"/></div>
