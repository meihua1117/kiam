...
*/
		...
		$resul_n_c=mysql_query($sql_n_c);
		$row_n_c=mysql_fetch_array($resul_n_c);
		if($row_n_c[idx])
		{
...
//				{
					...
					if($row_n_c[end_status] =="N")
					{
						...
						$resul_pay=mysql_query($sql_pay);
						if($cnt=mysql_num_rows($resul_pay))
						{
							$i=0;
							while($row_pay=mysql_fetch_array($resul_pay))
							{
								...
								$resul_num_cnt=mysql_query($sql_num_cnt);
								$row_num_cnt=mysql_fetch_array($resul_num_cnt);
