                ...
                <table class="list_table1" width="100%" border="0" cellspacing="0" cellpadding="3px">
                    ...
                    <tr id="step1">
                        ...
                        <td style="height:35px;text-align:left;" >
                            ...
                            <input type="button" value="스텝예약관리 조회" class="button " id="searchEventBtn1"> 
                    ...
                    <tr id="step2" style="display: none;">
                        ...
                        <td style="height:35px;text-align:left;" >
                            ...
                            <input type="button" value="스텝예약관리 조회" class="button " id="searchEventBtn2">
                        </td>
                    </tr>
                    <tr id="step3" style="display: none;">
                        <th class="w200">스텝문자연결3</td>
                        <td style="height:35px;text-align:left;" >
                            ...
                            <input type="button" value="스텝예약관리 조회" class="button " id="searchEventBtn3">
                        </td>
                    </tr>
                    <tr>
...
<span class="tooltiptext-bottom" id="event_other" style="display:none;">
	...
	<table class="table table-bordered" style="width: 97%;">
		<tbody>
			<tr class="hide_spec">
				<td class="bold" id="remain_count" data-num="" style="width:70px;padding:5px;"><p style="padding: 10px;">추가 문의 내용을 입력하세요.</p><br>
				<textarea name="set_event_other_req" id="set_event_other_req" style="width:100%; height:150px;font-size: 12px"><?=$row[event_req_link]?></textarea></td>
			</tr>
		</tbody>
	</table>
...
function cancel(){
    ...
    // $("#event_info8").prop('checked', false);
}
