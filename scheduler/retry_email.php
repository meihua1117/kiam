...
$sql_all = "select * from gn_mail where reservation < DATE_FORMAT(DATE_ADD(now(),INTERVAL -5 MINUTE),'%Y-%m-%d %H:%i:%s') and reservation >= DATE_FORMAT(DATE_ADD(now(),INTERVAL -30 MINUTE),'%Y-%m-%d %H:%i:%s') and up_date is null";
