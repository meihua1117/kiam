...
<table class="list_table" width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <a href="javascript:void(0)" onclick="order_sort(group_detail_form,'name',group_detail_form.order_status.value)">이름<? if($_REQUEST['order_name']=="name"){echo $_REQUEST['order_status']=="desc"?'▼':'▲';}else{ echo '▼'; }?></a></li></td>
  ...
  if($intRowCount)
  {
	  ...
	  {	  
          ...
          <tr>
            ...
            <td class="g_dt_name_<?=$i?> stop-dragging" ><li><!--<input type="checkbox" name="name_box" value="<?=$row['recv_num']?>" id='lbox_<?=$i?>' onclick="box_ed('<?=$i?>')" />--></li><li><label for="lbox_<?=$i?>"><?=$row['name']?></label></li></td>
