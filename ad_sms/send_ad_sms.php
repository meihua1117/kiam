...
<script>
    ...
    function onSearchDB() {
        ...
        $("#ajax-loading").show();
        phones = [];
        $.post('/ad_sms/search_ad_db.php', {'addr':search_addr,'com_type':search_job,'rank':search_job_title,'from_age':search_from_age,'to_age':search_to_age,'gen':search_gen,'school':search_school,'marrage':search_marrage,'only_count':'0'}, function(res){
            $("#ajax-loading").hide();
            if(res.status == '1') {
                phones = res.phones;
                var cost = res.cost;
    ...
    function onAddrConfirm(){
        ...
        $("#ajax-loading").show();
        phones = [];
        $.post('/ad_sms/search_ad_db.php', {'addr':search_addr,'com_type':search_job,'rank':search_job_title,'from_age':search_from_age,'to_age':search_to_age,'gen':search_gen,'school':search_school,'marrage':search_marrage,'only_count':'1'}, function(res){
            $("#ajax-loading").hide();
            if(res.status == '1') {
                count = res.count;
