...
<div class="big_1">
    	<div class="m_div">
            ...
            <div class="right_sub_menu">
                ...
                -->
                <a href="sub_5.php">휴대폰등록</a> ㅣ <a href="sub_6.php">문자발송</a> ㅣ <a href="daily_list.php">데일리발송</a> ㅣ <a href="sub_4_return_.php">발신내역</a> ㅣ <a href="sub_4.php?status=5&status2=3">수신내역</a> ㅣ <a href="sub_4.php?status=6">수신여부</a>
            </div>
						...
						<div>
							<div class="sub_4_2_t1">
								...
								<div class="div_240">
									...
									<div><a href="javascript:void(0)" onclick="send_msg_new(sub_4_form)"><img src="images/sub_button_68.jpg" /></a></div>     
								</div>                            
							</div>
							<div class="sub_4_2_t2">
								<div><img src="images/sub_button_05.jpg" /></div>
								<div class="div_340">
									<div class="d_font popup_holder" style="width:150px;float:left;margin-top:0px;">
										엑셀 업로드
										<div class="popupbox" style="background:white">
											Tooltip1<br>
											<a href="http://kiam.kr">http://kiam.kr</a>
										</div> 
									...
									<div style="float:right;" class="popup_holder">
										...
										<div class="popupbox" style="background:white">여기를 클릭하면 자신의 폰 연락처 디비를 가져와서 자동으로 주소록을 만들어줍니다
										</div>
									</div>
							...
							<div class="sub_4_2_t3">
								...
								<div class="div_280" style="margin-top:0px">
									...
									<div class="button_box">
										<div class="left_box">
											<span class="button_type"><a href="javascript:void(0)" onclick="select_app_check_push()">앱 상태 체크</a><span class="popbutton5 pop_view pop_right">?</span></span>
										</div>								
										<table class="list_table" width="100%" cellspacing="0" cellpadding="0" style="background:#fff">
											<tr>
