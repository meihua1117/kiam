...
// 올앳관련 함수 Include
//----------------------
include_once "./allat/mp/allatutil.php";
            ...
            <table class="write_table" width="100%" cellspacing="0" cellpadding="0">
                ...
                <tr>
                	...
                	<?php
                	    ...
                	    else if($_POST['cur_url'] == "we_story"){
                		$url = "/?cur_win=".$_POST['cur_url']."&search_key=&key1=3&key2=0";
                	    }
                	    else{
                		$url = "/?cur_win=".$_POST['cur_url'];
                	    }
                	?>
                	    <input type="button" value="메인으로" onclick="location.href='<?=$url?>';" />
                        &nbsp;&nbsp;&nbsp;
                        <input type="button" value="결제다시하기" onclick="location.href = '/pay_spoc.php';"  />
                    </td>
                </tr>
            </table>
        </div>
