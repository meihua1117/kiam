        ...
        <section class="content">
          <div class="row" id="toolbox">
            <div class="col-xs-12" style="padding-bottom:20px">
              ...
              <button class="btn btn-primary pull-right" style="margin-right: 5px;" onclick="location='faq_write.php'"><i class="fa fa-download"></i> 작성하기</button>
              <button class="btn btn-primary pull-right" style="margin-right: 5px;" onclick="$('#s_form').submit();"><i class="fa fa-download"></i> 순서변경</button>
          ...
          <div class="row">
              <form method="post" name="s_form" id="s_form" action="ajax/board_save.php">
              ...
              <div class="box">
                <div class="box-body">
                  ...
                  <?
                    ...
                    $orderQuery .= "
                    	ORDER BY sort_order desc, no DESC
                    	$limitStr
                    ";            	
                  ...
                  ?>
                      <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="sort_order[]" value="<?=$row['sort_order']?>" style="width:50px">
                        </td>                        
                        <td><?=$row['view_cnt']?></td>
