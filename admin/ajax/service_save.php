...
if ($_POST['mode'] == "inser") {
    ...
    $query = "update Gn_Iam_Service set ai_card_point = '',
                                        ...
                                        card_point_start = '',
                                        card_point_end = '',
                                        contents_point_start = '',
                                        contents_point_end = '',
                                        autodata_point_start = '',
                                        autodata_point_end = '',
                                        callback_point_start = '',
                                        callback_point_end = '',
                                        daily_point_start = '',
                                        daily_point_end  = '' 
                                    WHERE sub_domain='$sub_domain'";
    mysqli_query($self_con, $query);
}else if ($_POST['mode'] == "shoping_updat") {
    $query = "update Gn_Service set shoping_manage = {$_POST['status']} WHERE idx={$_POST['index']}";
