...
if ($_POST['mode'] == "creat") {
    ...
    $updateQuery = "";
    if (isset($_POST['head_logo_type']))
        $updateQuery .= "head_logo_type='$head_logo_type',";
    if (isset($_POST['head_logo']))
        $updateQuery .= "head_logo='$head_logo',";
    if (isset($_POST['head_logo_text']))
        $updateQuery .= "head_logo_text='$head_logo_text',";
    if (isset($_POST['footer_logo_type']))
        $updateQuery .= "footer_logo_type='$footer_logo_type',";
    if (isset($_POST['footer_logo']))
        $updateQuery .= "footer_logo='$footer_logo',";
    if (isset($_POST['footer_logo_text']))
        $updateQuery .= "footer_logo_text='$footer_logo_text',";
    if (isset($_POST['mem_id']))
        $updateQuery .=  "mem_id='$mem_id',";
    if (isset($_POST['mem_name']))
        $updateQuery .=  "mem_name='$mem_name',";
    if (isset($_POST['main_domain']))
        $updateQuery .=  "main_domain ='$main_domain',";
    if (isset($_POST['sub_domain']))
        $updateQuery .=  "sub_domain ='$sub_domain',";
    if (isset($_POST['brand_name']))
        $updateQuery .=  "brand_name='$brand_name',";
    if (isset($_POST['mem_cnt']))
        $updateQuery .=  "mem_cnt ='$mem_cnt',";
    if (isset($_POST['iamcard_cnt']))
        $updateQuery .=  "iamcard_cnt ='$iamcard_cnt',";
    if (isset($_POST['send_content']))
        $updateQuery .=  "send_content ='$send_content',";
    if (isset($_POST['my_card_cnt']))
        $updateQuery .=  "my_card_cnt ='$my_card_cnt',";
    if (isset($_POST['share_price']))
        $updateQuery .=  "share_price='$share_price',";
    if (isset($_POST['month_price']))
        $updateQuery .=  "month_price='$month_price',";
    if (isset($_POST['status']))
        $updateQuery .=  "status ='$status',";
    if (isset($_POST['owner_name']))
        $updateQuery .=  "owner_name ='$owner_name',";
    if (isset($_POST['manager_name']))
        $updateQuery .=  "manager_name= '$manager_name',";
    if (isset($_POST['company_name']))
        $updateQuery .=  "company_name ='$company_name',";
    if (isset($_POST['business_number']))
        $updateQuery .=  "business_number='$business_number',";
    if (isset($_POST['communications_vendors']))
        $updateQuery .=  "communications_vendors ='$communications_vendors',";
    if (isset($_POST['address']))
        $updateQuery .=  "address ='$address',";
    if (isset($_POST['privacy']))
        $updateQuery .=  "privacy ='$privacy',";
    if (isset($_POST['fax']))
        $updateQuery .=  "fax ='$fax',";
    if (isset($_POST['owner_cell']))
        $updateQuery .=  "owner_cell ='$owner_cell',";
    if (isset($_POST['manager_tel']))
        $updateQuery .=  "manager_tel= '$manager_tel',";
    if (isset($_POST['email']))
        $updateQuery .=  "email ='$email',";
    if (isset($_POST['contract_start_date']))
        $updateQuery .=  "contract_start_date='$contract_start_date',";
    if (isset($_POST['contract_end_date']))
        $updateQuery .=  "contract_end_date='$contract_end_date',";
    if (isset($_POST['web_theme']))
        $updateQuery .=  "web_theme='$web_theme',";
    if (isset($_POST['home_link']))
        $updateQuery .=  "home_link='$home_link',";
    if (isset($_POST['footer_link']))
        $updateQuery .=  "footer_link='$footer_link',";
    if (isset($_POST['kakao']))
        $updateQuery .=  "kakao='$kakao',";
    $query = "update  Gn_Iam_Service set  $updateQuery
                                    profile_idx='$profile_idx',
                                    kakao_api_key='$kakao_api_key',
                                    pay_link='$pay_link',
                                    service_type = '$service_type',
    ...
    exit;
} else if ($_POST['mode'] == "clear_logo") {
    $idx = $_POST['idx'];
    $query = "update Gn_Iam_Name_Card set profile_logo = '' where idx = $idx";
    mysqli_query($self_con, $query);
    echo json_encode(array("result" => "success"));
    exit;
} else if ($_POST['mode'] == "clear_footer_logo") {
    $idx = $_POST['idx'];
    $query = "update Gn_Iam_Service set footer_logo = '' where idx = $idx";
    mysqli_query($self_con, $query);
    echo json_encode(array("result" => "success"));
    exit;
} else if ($_POST['mode'] == "clear_head_logo") {
    $idx = $_POST['idx'];
    $query = "update Gn_Iam_Service set head_logo = '' where idx = $idx";
    mysqli_query($self_con, $query);
    echo json_encode(array("result" => "success"));
    exit;
}
if ($from_page == "iama")
    echo "<script>alert('저장되었습니다.');history.back(-1);</script>";
else
