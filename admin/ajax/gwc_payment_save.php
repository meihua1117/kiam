...
if($type == "main"){
    ...
    $query = "select * from tjd_pay_result_gwc where no='$no'";
    ...
    $sql_pay = "select sum(TotPrice) as all_money from tjd_pay_result_gwc where cash_prod_pay=0 and buyer_id='{$row['buyer_id']}' and date>'$date_pre_month' and end_status='Y'";
