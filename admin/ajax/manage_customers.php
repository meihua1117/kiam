...
if($mode == "creat"){
    ...
    if($type == "member_reg_edit" || $type == "member_req_edit" || $type == "member_get_edit"){
        ...
        echo json_encode(array($prefix.'name'=>$row_mem_data['mem_name'], 
        ...
        echo json_encode(array("reg_name"=>$row_mem_data['name'], 
        ...
        echo json_encode(array("req_name"=>$row_mem_data['name'], 
        ...
        echo json_encode(array("get_name"=>$row_mem_data['ceo'], 
