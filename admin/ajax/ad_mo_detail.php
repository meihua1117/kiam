                      ...
                      <tr>
                        ...
                        <td>
                            <Select name="ad_position">
                                <option value="T" <?php echo $row['ad_position']=="T"?"selected":""?>>셀링앱상단</option>
                                <option value="B" <?php echo $row['ad_position']=="B"?"selected":""?>>셀링앱하단</option>
                                <option value="H" <?php echo $row['ad_position']=="H"?"selected":""?>>메인홈피상단</option>
