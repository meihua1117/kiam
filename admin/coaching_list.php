                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content animated bounceInRight">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-3" style="font-size: 16px;">본사평가</div>
                                                    <div class="col-md-9">
                                                        <input type="email" class="site_value_input form-control" placeholder="5=훌륭해요 4=좋았어요 3=괜찮아요 2=보완해요 1=대안필요" value="<?= $coaching_info_data['site_value'] ?>" <? if ($coaching_info_data['site_comment'] != "") {
                                                                                                                                                                                                                    echo "disabled";
                                                                                                                                                                                                                } ?>>
                                                    </div>
                                                ...
                                                <? } ?>
                                                <div class="row">
                                                    <div class="col-md-3" style="font-size: 16px;">본사의견</div>
                                                    <div class="col-md-9">
                                                        <input type="email" class="site_comment_input form-control" value="<?= $coaching_info_data['site_comment'] ?>" <? if ($coaching_info_data['site_comment'] != "") {
                                                                                                                                                                        echo "disabled";
                                                                                                                                                                    } ?>>
                                                    </div>
                                                </div>
                                ...
                                <script type="text/javascript">
                                    function onSiteComment(coaching_id) {
                                        ...
                                        $.ajax({
                                            ...
                                            url: "/mypage.proc.php",
                                            data: {
                                                mode: "update_coaching_info_site_comment",
                                                site_value: site_value_input,
                                                site_comment: site_comment_input,
...
<script>
    ...
    $('.chkagree').change(function() {
        ...
        $.ajax({
            ...
            data: {
                mode: "update_coaching_info_agree",
                coaching_id: coaching_id,
                status: status
            },
            dataType: 'html',
