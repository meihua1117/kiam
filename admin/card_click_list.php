...
function goPage(pgNum) {
    location.href = '?nowPage='+pgNum+"&search_key=<?=$search_key?>&type=<?=$type;?>&orderField=<?=$orderField?>&dir=<?=$dir?>";
}
$(function() {
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>아이엠카드 관리<small>아이엠카드를 관리합니다.</small></h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">아이엠카드관리</li>
            </ol>
        </section>
        <!-- Main content -->
        <section class="content">
            <div class="row" id="toolbox">
                ...
                <button class="btn btn-primary pull-right" style="margin-right: 5px;" onclick="location.href='card_group_list.php'"><i class="fa"></i>그룹 페이지 관리</button>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <thead>
                                <tr>
                                    <th>NO</th>
                                    <th>IDX</th>
                                    <th><a href="?orderField=mem_id&dir=<?=$dir?>" class="sort-by">소속/아이디</a></th>
                                    <th>카드명</th>
                                    <!-- <th>카드<br>링크</th> -->
                                    <th>IMAGE</th>
                                    <th>VIDEO</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div style="width:100px;">
                                                <video class="zoom" src="<?=$row['video']?>" type="video/mp4" autoplay muted loop style="width:100%;"></video>
                                            </div>
                                            <?}?>
                                        </td>
                                        <td>
                                        ...
                                        <td style="font-size:12px;">
                                            <label class="switch">
                                                ...
                                                <span class="slider round" name="status_round" id="card_call_<?=$row['idx'];?>"></span>
                                            </label>
                                        </td>
...
$(function(){
    ...
    $('.chkcall').change(function() {
        ...
        $.ajax({
            ...
            url:"/admin/ajax/_db_controller.php",
            data:{
                mode:"update_name_card - call_click",
