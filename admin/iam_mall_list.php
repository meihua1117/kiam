                            ...
                            <tbody>
                                ...
                                while($row = mysqli_fetch_array($res)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label class="switch">
                                                <input type="checkbox" class="chkagree" name="status" id="mall_sample_<?php echo $row['idx'];?>"<?php echo $row['sample_display']!='N'?"checked":""?> >
                                                <span class="slider round" name="status_round" id="mall_sample_<?php echo $row['idx'];?>"></span>
                                            </label>
                                        </td>
                                        <td>
                                            <div style="overflow-x:hidden;width:100px;">
                                        ...
                                        <td>
                                            <label class="switch">
                                                <input type="checkbox" class="chkagree" name="status" id="mall_idx_<?php echo $row['idx'];?>"<?php echo $row['display_status']!=0?"checked":""?> >
                                                <span class="slider round" name="status_round" id="mall_idx_<?php echo $row['idx'];?>"></span>
                                            </label>
                                        </td>
                                        <td><?=$row['reg_date']?></td>
                                        <td>
