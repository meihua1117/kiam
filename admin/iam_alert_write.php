...
<?include_once $_SERVER['DOCUMENT_ROOT']."/admin/include/admin_header_menu.inc.php";?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>아이엠 기능알림 등록<small>아이엠 기능별 알림정보를 등록합니다.</small></h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">아이엠 기능알림 등록</li>
            </ol>
        </section>
        <form method="post" id="dForm" name="dForm" action="/admin/ajax/gn_alert_ajax.php"  enctype="multipart/form-data">
            ...
            <section class="content">
                <div class="row">
                    <div class="box">
                        <div class="box-header">
                          <h3 class="box-title">[아이엠 기능 알림 상세정보]</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                ...
                <div class="box-footer" style="text-align:center">
                    ...
                    <button class="btn btn-primary" style="margin-right: 5px;" onclick="location='iam_alert_list.php';return false;"><i class="fa fa-list"></i> 목록</button>
                </div>
            </section><!-- /.content -->
        </form>
    </div><!-- /content-wrapper -->
