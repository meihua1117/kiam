...
<div class="wrapper" style="display: flex;overflow: initial">
    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
            <h1>
                굿웰스회원관리<small>굿웰스회원을 관리합니다.</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">굿웰스회원관리</li>
            </ol>
        </section>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center">신청일/승인일</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button style="border: 1px solid #2196f3;padding: 2px;<?=$row['gwc_req_leb'] == $row['gwc_leb']?'':'background-color:lightblue;'?>" <?=$row['gwc_req_leb'] == $row['gwc_leb']?'disabled':''?> onclick="request_btn('<?=$row['mem_code']?>')">신청</button><?php
                                            ...
                                            <? if(str_replace("-", "",$row['mem_phone'])==$row['sendnum']||$row['sendnum']==""){?>
                                                <select name="gwc_leb" id="gwc_leb<?=$row['mem_code']?>">
                                                    <option value="0" <? echo $row['gwc_leb'] == "0"?"selected":""?>>일반</option>
                                                    <option value="1" <? echo $row['gwc_leb'] == "1"?"selected":""?>>가입회원</option>
                                                    <option value="2" <? echo $row['gwc_leb'] == "2"?"selected":""?>>소비회원</option>
                                                    <option value="3" <? echo $row['gwc_leb'] == "3"?"selected":""?>>공급회원</option>
