              ...
              <tr>
                ...
                <td>
                  <?php if ($_SESSION['one_member_subadmin_id'] == "") { ?>
                    <a href="member_detail_con.php?mem_code=<?= $row['mem_code'] ?>&sendnum=<?= $row['sendnum'] ?>">수정</a> /
                    <a href="javascript:del_member_info('<?= $row['mem_code'] ?>')">탈퇴</a>
                </td>
              <? } ?>
              <td><?= $row['site'] ?></td>
              <td>
              ...
              <td>
                <?php if (str_replace("-", "", $row['mem_phone']) == $row['sendnum'] || $row['sendnum'] == "") { ?>
                  <select name="mem_iam_type" id="mem_iam_type<?= $row['mem_code'] ?>">
                    <option value="0" <?php echo $row['mem_iam_type'] == "0" ? "selected" : "" ?>>무료이용자</option>
                    <option value="1" <?php echo $row['mem_iam_type'] == "1" ? "selected" : "" ?>>유료이용자</option>
                    <option value="2" <?php echo $row['mem_iam_type'] == "2" ? "selected" : "" ?>>맞춤개인</option>
                    <option value="3" <?php echo $row['mem_iam_type'] == "3" ? "selected" : "" ?>>맞춤사업</option>
                    <option value="4" <?php echo $row['mem_iam_type'] == "4" ? "selected" : "" ?>>맞춤회사</option>
                    <option value="5" <?php echo $row['mem_iam_type'] == "5" ? "selected" : "" ?>>맞춤단계</option>
                  </select>
                  <?php if ($_SESSION['one_member_admin_id'] == "onlyonemaket" || $_SESSION['one_member_subadmin_id'] != "") { ?>
                  <?php } else { ?>
