...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>리포트 관리<small>리포트를 관리합니다.</small></h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">리포트관리</li>
            </ol>
        </section>
        <!-- Main content -->
            ...
            <div class="row" id="toolbox">
                <div class="col-xs-12" style="padding-bottom:20px">
                    <div style="padding:10px">
                        <button class="btn btn-primary pull-right" style="margin-right: 5px;" onclick="cloneMultiRow();"><i class="fa"></i> 복제하기</button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label class="switch_repo_status" style="margin:0 25px;">
                                                <input type="checkbox" name="status" id="stauts_logo_<?= $row['id']; ?>" value="<?= $row['id']; ?>" <?= $row['status'] == 1 ? "checked" : "" ?>>
                                                <span class="slider round" name="status_round" id="stauts_round_<?= $row['idx']; ?>"></span>
                                            </label>
                                        </td>
                                    </tr>
                                <?
