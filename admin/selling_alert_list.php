...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>셀링 기능알림 관리<small>셀링 기능별 알림정보를 관리합니다.</small></h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">셀링 기능알림 관리</li>
            </ol>
        </section>
        <!-- Main content -->
        <section class="content">
            <div class="row" id="toolbox">
                <form method="get" name="search_form" id="search_form">
                    <button class="btn btn-primary pull-right" style="margin-right: 5px;" onclick="location='selling_alert_write.php';return false;"><i class="fa fa-download"></i> 등록</button>
                    <button class="btn btn-primary pull-right" style="margin-right: 5px;" onclick="location='selling_video_list.php';return false;"><i class="fa"></i> 셀링동영상</button>
                    <button class="btn btn-default pull-right" style="margin-right: 5px;" onclick="location='selling_alert_list.php';return false;"><i class="fa"></i> 셀링알림</button>
                ...
                <div class="box">
                    <div class="box-body" style="overflow: auto !important">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            $query = "SELECT SQL_CALC_FOUND_ROWS * FROM gn_alert WHERE `type`='selling' $searchStr";
                            ...
                            while($row = mysqli_fetch_array($res)) {?>
                                <tr>
                                    ...
                                    <td><?=$row['title']?></td>
                                    <td><?=$row['pos']?></td>
                                    <td><?=str_replace("http://www.kiam.kr",$cdn_ssl, $row['img']);?></td>
                                    <td><?=$row['desc']?></td>
                                    <td><?=$row['link']?></td>
                                    <td>
                                        <a href="selling_alert_write.php?no=<?=$row['no']?>">수정</a> /
