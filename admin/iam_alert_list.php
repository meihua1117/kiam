...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>아이엠 기능알림 관리<small>아이엠 기능별 알림정보를 관리합니다.</small></h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">아이엠 기능알림 관리</li>
            </ol>
        </section>
        <!-- Main content -->
        <section class="content">
            <div class="row" id="toolbox">
                <form method="get" name="search_form" id="search_form" style="width: auto;">
                    <button class="btn btn-primary pull-right" style="margin-right: 5px;" onclick="location='iam_alert_write.php';return false;"><i class="fa"></i> 등록</button>
                    ...
                    <button class="btn btn-default pull-right" style="margin-right: 5px;" onclick="location='iam_alert_list.php';return false;"><i class="fa"></i> 아이엠알림</button>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            while($row = mysqli_fetch_array($res)) {?>
                                <tr>
                                    ...
                                    <td><?=$row['link']?></td>
                                    <td>
                                        <a href="iam_alert_write.php?no=<?=$row['no']?>">수정</a> /
