...
<script>
//계정 삭제
function del_member_info(cam_id){
	var msg = confirm('정말로 삭제하시겠습니까?');
	if(msg){
			$.ajax({
				type:"POST",
				url:"/admin/ajax/ad_pc_delete.php",
				data:{cam_id:cam_id},
				success:function(){
					alert('삭제되었습니다.');
					location.reload();
        ...
        <section class="content">
          <div class="row" id="toolbox">
            <div class="col-xs-12" style="padding-bottom:20px">
              <button class="btn btn-primary pull-right" style="margin-right: 5px;" onclick="location='ad_pc_detail.php';return false;"><i class="fa fa-download"></i> 등록</button>
              ...
              <div class="box">
                <div class="box-body">
                  ...
                  <?
                	...
                	$query = "SELECT SQL_CALC_FOUND_ROWS `cam_id`, `ad_position`, `client`,`title`, `img_url`, `move_url`, `use_yn`, `start_date`,`send_start_date`, `send_end_date`,`display_time`, `start_time`, `end_time` ,view_time
                        	FROM crawler_ad_manager 
                        	WHERE 1=1 
                	              $searchStr";
                  ...
                  ?>
                      <tr>
                        ...
                        <td><?php echo $row['send_start_date']?></td>
                        ...
                        <td><?php echo $row['display_time']?></td>
                        <td><?php echo $row['view_time']?> 초</td>

                        <td>
                            <a href="ad_pc_detail.php?cam_id=<?=$row['cam_id']?>">수정</a> / 
                            <a href="javascript:del_member_info('<?=$row['cam_id']?>')">삭제</a></td>                        
                      </tr>
                    <?
                    $c++;
                    $i++;
