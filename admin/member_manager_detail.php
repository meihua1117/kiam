...
// 가입 회원 상세 정보
$query = "select `mem_code`, `mem_leb`, `mem_group`, `mem_id`, `mem_pass`, `web_pwd`, `mem_name`,
          `mem_nick`, `mem_post`, `mem_add1`, `mem_add2`, `mem_phone`, `mem_fax`, `mem_email`, `mem_birth`,
          `bank_name`, `bank_owner`, `bank_account`, `zy`, `is_message`, `first_regist`,
          `last_modify`, `visited`, `site`, `fujia_date2`, `login_date`, `phone_cnt`,
          `total_pay_money`, `mem_type`,(select count(*) from Gn_MMS_Number where 1=1 and ( not (cnt1 = 10 and cnt2 = 20)) and mem_id =Gn_Member.mem_id) tcnt
            from Gn_Member where mem_code='$mem_code'";
$res = mysqli_query($self_con,$query);
$data = mysqli_fetch_array($res);

// 기부회원 상세 정보
$query = "select `idx`, `mem_id`, `sendnum`, `max_cnt`, `user_cnt`, `gl_cnt`, `month_cnt`, `today_cnt`, `over_cnt`,
          `memo`, `reg_date`, `up_date`, `max_over_cnt`, `memo2`, `device`, `memo3`, `usechk`, `cnt1`, `cnt2`,
          `format_date`, `end_status`, `end_date`, `donation_rate`, `daily_limit_cnt`, `use_order`
      ...
      <div class="content-wrapper">
                  ...
                  <table id="detail1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <th>기부폰승인</th>
                        <td>
                            <input type="text" style="width:100px;" name="phone_cnt" value="<?=$data['phone_cnt']?>" > 
                        </td>
                        <th>회원가입일</th>
                      ...
                      <tr>
                        ...
                        <th>주소</th>
                        <td colspan="3"><?=$data['mem_add1']?> <?=$data['mem_add2']?> (<?=$data['mem_post']?>)</td>
                      </tr>
                      <tr>
                        <th>생년월일</th>
                        <td><?=$data['mem_birth']?></td>
                        <th>직업</th>
                        <td colspan="3"><?=$data['zy']?></td>
                      </tr>                                                                                                                                                                
                    </tbody>
                  </table>
                </div><!-- /.box-body -->
        ...
        <?}?>
            ...
            <div class="box-footer" style="text-align:center">
                ...
                <button class="btn btn-primary" style="margin-right: 5px;" onclick="location='member_manager_list.php';return false;"><i class="fa fa-list"></i> 회원목록</button>
            </div>            
