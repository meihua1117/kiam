...
$query = "select recommend_id, mem_code, mem_id, mem_pass, web_pwd, mem_name,
          mem_nick, mem_post, mem_leb, service_type, iam_type, mem_add1, mem_add2, mem_phone, mem_email, mem_birth,
...
$sql_phone = "select max_cnt, add_phone, member_type, TotPrice, end_status, stop_yn from tjd_pay_result where buyer_id='{$data['mem_id']}' order by no desc limit 1";
                        ...
                        <div class="box-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if($data['special_type'] == "0") $special = "일반인";
                                            else if($data['special_type'] == "1") $special = "판매자";
                                            else if($data['special_type'] == "2") $special = "전문가";
                                            else if($data['special_type'] == "3") $special = "구인자";
                                            else if($data['special_type'] == "4") $special = "구직자";

                                            echo $level."/".$selling."/".$special;
                                            ?>    
                                        </td>
                                        <!-- <th>부가서비스</th>
                                        <td>
                                        ...
                                        <th>최근접속일<br>(총접속횟수)</th>
                                        <td><?=$data['login_date']?><br>(<?=$login_cnt?> 회)</td>
                                    </tr>
                                    <tr>
                                        <th>성명</th>
                                    ...
                                    <tr>
                                        ...
                                        <th>추천인아이디</th>
                                        <td>
                                            <input type="text" style="width:100px;" name="recommend_id" id="recommend_id" onblur="check_recommender()" value="<?php echo $data['recommend_id']?>"></td>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <th>회원관련메모</th>
                                        <td><textarea style="width:100%;height:100px;" name="mem_memo" id="mem_memo"><?=$data['mem_memo']?></textarea></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div><!-- /.box-body -->
...
<div id="group_name" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm" role="document" style="margin-top: 20%;max-width:300px;margin-left:auto;margin-right:auto;">
        <div class="modal-content">
            <div class="modal-header" style="border:none;border: none;background-color: #82c836;height: 45px;">
