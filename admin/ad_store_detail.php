...
if($cam_id) {
    // 가입 회원 상세 정보
    $query = "select * from Gn_Ad_Manager where cam_id='$cam_id'";
  ...
  crossorigin="anonymous">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <form method="post" id="dForm" name="dForm" action="/admin/ajax/ad_store_save.php"  enctype="multipart/form-data">
        ...
        <section class="content">
          ...
          <div class="row">
                  ...
                  <table id="detail1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th>광고소제목</th>
                        <td>
                        <input type="text" style="width:400px;" name="sub_title" id="sub_title" value="<?=$data['sub_title']?>" > 
                        </td>
                      </tr>                     
                      <tr>
                        <th>이동경로</th>
                      ...
                      <tr>
                        ...
                        <td>
                            ...
                            <?if($data['img_url']){?>
                              <img style="width:50%" src = "<?=$data['img_url']?>">
                            <?}?>
                        </td>
                      </tr>                      
                      <tr>
            ...
            <div class="box-footer" style="text-align:center">
                ...
                <button class="btn btn-primary" style="margin-right: 5px;" onclick="location='ad_store_list.php';return false;"><i class="fa fa-list"></i> 목록</button>
            </div>            
          </div><!-- /.row -->          
        </section><!-- /.content -->
        </form>
