        ...
        <section class="content">
            <div class="row" id="toolbox">
                <div class="col-xs-12" style="padding-bottom:20px">
                    ...
                    <button class="btn btn-primary pull-right" style="margin-right: 5px;" onclick="location='make_balance.php?search_year=<?= $search_year; ?>&search_month=<?= $search_month; ?>'"> 정산생성</button>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="payment_balance_list_advance_detail.php?mem_id=<?= $row['mem_id'] ?>&search_year=<?= $search_year; ?>&search_month=<?= $search_month; ?>"><?= "상세보기" ?></a></td>
                                        <td><?= $row['mem_id'] ?></td>
                                        <td><?= $row['mem_name'] ?></td>
                                        <td><?= $mem_level; ?></td>
                                        <td>
                                        ...
                                        <td>
                                            <form method="post" name="ssForm<?= $i ?>" id="ssForm<?= $i ?>" action="ajax/payment_balance_advance_save.php">
                                                ...
                                                <input type="hidden" name="balance_date" value="<?= $search_year . "" . $search_month ?>">
                                                ...
                                                <select name="end_status" class="select">
                                                    <option value="N" <?= $row['balance_yn'] == "N" ? "selected" : "" ?>>지급대기</option>
                                                    <option value="Y" <?= $row['balance_yn'] == "Y" ? "selected" : "" ?>>지급완료</option>
                                                </select>
            ...
            <div style="float:right;margin-right:20px;">
                / 미지급 합계 : <?= number_format($sum_share_fee - $sum_balance_fee); ?>
            </div>
            <div style="float:right;margin-right:20px;">
                / 지급 합계 : <?= number_format($sum_balance_fee); ?>
            </div>
            <div style="float:right;margin-right:20px;">
                수당 합계 : <?= number_format($sum_share_fee); ?>
            </div>
            <div class="row">
                <div class="col-sm-5">
...
<script>
    $("#total_share").html('<?= number_format($total_sum_share_fee); ?>');
    $("#total_balance").html('<?= number_format($total_sum_balance_fee); ?>');
</script>