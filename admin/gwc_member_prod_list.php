...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>굿마켓 회원계정 상품관리<small>굿마켓 회원계정 상품정보를 관리합니다.</small></h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">회원계정상품관리</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      <div class="row" id="toolbox">
        <div class="col-xs-12" style="padding-bottom:20px">
          <div>
            <button class="btn btn-primary pull-right" style="margin-right: 5px;" onclick="deleteMultiRow()">내보내기</button>
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                // 검색 조건을 적용한다.
                  ...
                  if($searchStr == null){
                    $count_query = "select count(*) from Gn_Iam_Contents_Gwc contents where contents.gwc_con_state!=0 and contents.ori_store_prod_idx!=0";
                  }
                  else{
                  ...
                  $query = "SELECT  cards.card_name as card_name , cards.card_title, contents.idx, contents.mem_id,contents.contents_type,contents.contents_img,contents.group_id,".
                      ...
                      "FROM Gn_Iam_Contents_Gwc contents inner join Gn_Iam_Name_Card cards on contents.card_idx = cards.idx WHERE contents.gwc_con_state!=0 and contents.ori_store_prod_idx!=0 $searchStr";
...
function deleteMultiRow() {
    ...
    if(confirm('내보내기 하시겠습니까?')) {
        $.ajax({
          ...
          dataType:"json",
          data:{mode:"goback_gwc_contents", id:no_array.toString()},
