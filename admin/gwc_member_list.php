    ...
    <div class="content-wrapper">
        ...
        <section class="content">
                            ...
                            <div class="box-tools">
                                <div class="input-group" style="display:inline-flex;width: 100%">
                                    ...
                                    <select name="iam_type" id="iam_type<?= $iam_type ?>">
                                        <option value="a" <?=$iam_type == "a" || $iam_type == '' ? "selected" : "" ?>>전체</option>
                                        <option value="0" <?=$iam_type == '0' && $iam_type != '' ? "selected" : "" ?>>FREE</option>
                                        <option value="1" <?=$iam_type == 1 ? "selected" : "" ?>>BASIC</option>
                                        <option value="2" <?=$iam_type == 2 ? "selected" : "" ?>>가맹점</option>
                                        <option value="3" <?=$iam_type == 3 ? "selected" : "" ?>>슈퍼바이저</option>
                                        <option value="4" <?=$iam_type == 4 ? "selected" : "" ?>>홍보대사</option>
                                    </select>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <? } ?>
                                    <th style="text-align: center">굿웰스등급</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td onclick="page_view('<?= $row['mem_id'] ?>');"><?= number_format($row['tcnt']) ?> <?=$row['memo']; ?></td>
                                        ...
                                        <!-- <td>
                                            <? if (str_replace("-", "", $row['mem_phone']) == $row['sendnum'] || $row['sendnum'] == "") { ?>
                                                <select name="mem_leb" id="mem_leb<?= $row['mem_code'] ?>">
                                                    <option value="22" <?=$row['mem_leb'] == "22" ? "selected" : "" ?>>일반</option>
                                                    <option value="50" <?=$row['mem_leb'] == "50" ? "selected" : "" ?>>코치</option>
                                                    <option value="21" <?=$row['mem_leb'] == "21" ? "selected" : "" ?>>강사</option>
                                                    <option value="60" <?=$row['mem_leb'] == "60" ? "selected" : "" ?>>홍보</option>
                                                </select>
                                            <? if ($_SESSION['one_member_admin_id'] != "" && $_SESSION['one_member_admin_id'] != "onlyonemaket") { ?>
                                        ...
                                        <td>
                                            ...
                                            <? if (str_replace("-", "", $row['mem_phone']) == $row['sendnum'] || $row['sendnum'] == "") { ?>
                                                <select name="gwc_leb" id="gwc_leb<?= $row['mem_code'] ?>">
                                                    <option value="4" <?=$row['gwc_leb'] == "4" ? "selected" : "" ?>>일반</option>
                                                    <option value="1" <?=$row['gwc_leb'] == "1" ? "selected" : "" ?>>굿슈머</option>
                                                    <option value="2" <?=$row['gwc_leb'] == "2" ? "selected" : "" ?>>공급사</option>
                                                    <option value="3" <?=$row['gwc_leb'] == "3" ? "selected" : "" ?>>센터</option>
                                                    <!-- <option value="4" <?=$row['gwc_leb'] == "4" ? "selected" : "" ?>>판매회원</option>
                                                    <option value="5" <?=$row['gwc_leb'] == "5" ? "selected" : "" ?>>팀리더</option>
                                                    <option value="6" <?=$row['gwc_leb'] == "6" ? "selected" : "" ?>>그룹리더</option>
                                                    <option value="7" <?=$row['gwc_leb'] == "7" ? "selected" : "" ?>>지역리더</option>
                                                    <option value="8" <?=$row['gwc_leb'] == "8" ? "selected" : "" ?>>국가리더</option>
                                                    <option value="9" <?=$row['gwc_leb'] == "9" ? "selected" : "" ?>>국제리더</option> -->
                                                </select>
                                                <? if ($_SESSION['one_member_admin_id'] != "" && $_SESSION['one_member_admin_id'] != "onlyonemaket") { ?>
                                        ...
                                        <td>
                                            <label class="switch">
                                                <input type="checkbox" name="status" id="stauts_<?=$row['mem_code']; ?>" value="<?=$row['mem_code']; ?>" <?=$row['gwc_state'] == "1" ? "checked" : "" ?>>
                                        ...
                                        <td>
                                            <? if (str_replace("-", "", $row['mem_phone']) == $row['sendnum'] || $row['sendnum'] == "") { ?>
                                                <select name="service_type" id="service_type<?= $row['mem_code'] ?>">
                                                    <option value="0" <?=$row['service_type'] == "0" ? "selected" : "" ?>>FREE</option>
                                                    <option value="1" <?=$row['service_type'] == "1" ? "selected" : "" ?>>이용자</option>
                                                    <option value="2" <?=$row['service_type'] == "2" ? "selected" : "" ?>>리셀러</option>
                                                    <option value="3" <?=$row['service_type'] == "3" ? "selected" : "" ?>>분양자</option>
                                                </select>
                                                <? if ($_SESSION['one_member_admin_id'] != "" && $_SESSION['one_member_admin_id'] != "onlyonemaket") { ?>
                                        ...
                                        <td>
                                            <? if (str_replace("-", "", $row['mem_phone']) == $row['sendnum'] || $row['sendnum'] == "") { ?>
                                                <select name="iam_pay_type" id="iam_pay_type<?= $row['mem_code'] ?>">
                                                    <option value="0" <?=$row['iam_type'] == 0 ? "selected" : "" ?>>FREE</option>
                                                    <option value="1" <?=$row['iam_type'] == 1 ? "selected" : "" ?>>BASIC</option>
                                                    <option value="2" <?=$row['iam_type'] == 2 ? "selected" : "" ?>>가맹점</option>
                                                    <option value="3" <?=$row['iam_type'] == 3 ? "selected" : "" ?>>슈퍼바이저</option>
                                                    <option value="4" <?=$row['iam_type'] == 4 ? "selected" : "" ?>>홍보대사</option>
                                                </select>
                                                <? if ($_SESSION['one_member_admin_id'] != "" && $_SESSION['one_member_admin_id'] != "onlyonemaket") { ?>
                                        ...
                                        <td style="width:100px;">
                                            ...
                                            ?>
                                                ...
                                                <option value="0" <?=$row['special_type'] == 0 ? "selected" : "" ?>>판매자</option>
                                                <option value="1" <?=$row['special_type'] == 1 ? "selected" : "" ?>>전문가</option>
                                                <option value="2" <?=$row['special_type'] == 2 ? "selected" : "" ?>>구인자</option>
                                                <option value="3" <?=$row['special_type'] == 3 ? "selected" : "" ?>>구직자</option>
                                            </select> -->
                                                <? if ($_SESSION['one_member_admin_id'] != "" && $_SESSION['one_member_admin_id'] != "onlyonemaket") { ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-7">
                    <?=drawPagingAdminNavi($totalCnt, $nowPage, $pageCnt); ?>
                </div>
            </div>
        </section><!-- /.content -->
    </div><!-- /content-wrapper -->
