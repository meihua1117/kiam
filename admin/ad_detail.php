  ...
  crossorigin="anonymous"></script>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <form method="post" id="dForm" name="dForm" action="/admin/ajax/ad_save.php"  enctype="multipart/form-data">
                  ...
                  <table id="detail1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th>발송건수</th>
                        <td>
                            <input type="text" style="width:100px;" name="send_count" id="send_count" value="<?=$data['send_count']?>" > 
                        </td>
                      </tr>                                   
                      <tr>
                        <th rowspan="3">내용관리</th>
                        <th>광고제목</th>
                        <td>
                      ...
                      <tr>
                        <th>광고문구</th>
                        <td>
                            <textarea name="content" id="content" style="width:500px"><?=$data['content']?></textarea>
                        </td>
                      </tr>
                      <tr>
                        <th>광고이미지</th>
                      ...
                      <tr>
                        ...
                        <td>
                            <select name="status">
                                <option value="N" <?echo $data['status']=="N"?"selected":""?>>미발송</option>
                                <option value="C" <?echo $data['status']=="C"?"selected":""?>>진행중</option>
                                <option value="Y" <?echo $data['status']=="Y"?"selected":""?>>완료</option>
                            </select>
                        </td>
                      </tr>                        
                    </tbody>
