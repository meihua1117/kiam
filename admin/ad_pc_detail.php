    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            디버 광고관리
            <small>디버 광고를 관리합니다.</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">디버 광고관리</li>
          </ol>
        </section>
        ...
        <form method="post" id="dForm" name="dForm" action="/admin/ajax/ad_pc_save.php"  enctype="multipart/form-data">
        ...
        <section class="content">
          ...
          <div class="row">
                ...
                <div class="box-body">
                  <table id="detail1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th rowspan="6">내용관리</th>
                        <th>광고제목</th>
                        <td>
                            <!--<input type="text" style="width:400px;" name="title" id="title" value="<?=$data['title']?>" >--> 
                            <textarea name="title" id="title" style="width:550px;height:100px" placeholder = "제목 혹은 공지내용" ><?php echo $data['title']?></textarea>
                        </td>
                      </tr>                      
                      <tr>
                        <th>이동경로</th>
                      ...
                      <tr>
                        <th>윈도우용 노출</th>
                        <td>
                            <input type="text" style="width:100px;" name="display_time" id="display_time" value="<?=$data['display_time']?>" > 
                            ex) 09,12,15,20
                        </td>
                      </tr>         
                      <tr>
                        <th>노출시간</th>
                        <td>
                            <input type="text" style="width:100px;" name="view_time" id="view_time" value="<?=$data['view_time']?>" > 
                            초
                        </td>
                      </tr>         
                      <tr>
                        ...
                        <td>
                            <select name="ad_position">
                                <option value="app" <?echo $data['ad_position']=="app"?"selected":""?>>디버 상단</option>
                                <option value="dber" <?echo $data['ad_position']=="dber"?"selected":""?>>디버 공지</option>
                                <option value="window" <?echo $data['ad_position']=="window"?"selected":""?>>윈도우 하단</option>
                            </select>
                        </td>
                      </tr>                      
                      <tr>
            ...
            <div class="box-footer" style="text-align:center">
                ...
                <button class="btn btn-primary" style="margin-right: 5px;" onclick="location='ad_list.php';return false;"><i class="fa fa-list"></i> 목록</button>
            </div>            
          </div><!-- /.row -->          
        </section><!-- /.content -->
        </form>
