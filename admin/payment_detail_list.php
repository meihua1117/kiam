    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            결제관리
            <small>결제를 관리합니다.</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">결제관리</li>
          </ol>
        </section>
                      ...
                      <tr>
                        ...
                        <td>
                            ...
                            <select name="payment_day">
                                ...
                                <option value="20" <?php echo $row['payment_day'] == "25"?"selected":""?>>20</option>
                                <option value="25" <?php echo $row['payment_day'] == "25"?"selected":""?>>25</option>
                                <option value="30" <?php echo $row['payment_day'] == "25"?"selected":""?>>30</option>
