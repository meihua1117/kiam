...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        셀링앱 광고관리
        <small>셀링앱 광고를 관리합니다.</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">셀링앱 광고관리</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row" id="toolbox">
        <div class="col-xs-12" style="padding-bottom:20px">
          <button class="btn btn-primary pull-right" style="margin-right: 5px;" onclick="location='ad_mo_detail.php';return false;"><i class="fa fa-download"></i> 등록</button>
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a href="ad_mo_detail.php?cam_id=<?= $row['cam_id'] ?>">수정</a> /
                    <a href="javascript:del_row_info('<?= $row['cam_id'] ?>')">삭제</a>
                  </td>
                </tr>
              <?
                $c++;
