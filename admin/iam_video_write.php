...
<div class="wrapper"  style="height:100%;overflow:auto">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>아이엠 동영상 등록<small>아이엠 동영상  정보를 등록합니다.</small></h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">아이엠 동영상 등록</li>
            </ol>
        </section>
        <form method="post" id="dForm" name="dForm" action="/admin/ajax/gn_video_ajax.php"  enctype="multipart/form-data">
            ...
            <input type="hidden" name="type" value="iam" />
            <!-- Main content -->
            <section class="content">
                <div class="row">
                    <div class="box">
                        <div class="box-header">
                          <h3 class="box-title">[아이엠 동영상 상세정보]</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" style="width:250px;" name="use_status" id="use_status" value="<?=$data['use_status']?>" >
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>노출</th>
                ...
                <div class="box-footer" style="text-align:center">
                    ...
                    <button class="btn btn-primary" style="margin-right: 5px;" onclick="location='iam_video_list.php';return false;"><i class="fa fa-list"></i> 목록</button>
                </div>
            </section><!-- /.content -->
        </form>
    </div><!-- /content-wrapper -->
