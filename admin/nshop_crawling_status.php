...
if($_POST['get'] == true){
    ...
    $sql = "SELECT state_flag, mem_id, keyword FROM crawler_status_info where mem_id='{$mem_id}' and type='NAVERSHOP' and contents_cnt={$contents_cnt} ORDER BY id DESC LIMIT 1";
