    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            FAQ 카테고리
            <small>FAQ 카테고리를 관리합니다. 띄어쓰기 없이,를 찍어 카테고리를 추가하세요.</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">FAQ 카테고리</li>
          </ol>
        </section>
        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12" style="padding-bottom:20px">
              ...
              <button class="btn btn-primary pull-right" style="margin-right: 5px;" onclick="saveForm();"><i class="fa fa-download"></i> 등록</button>
              <?php }?>
              <form method="get" name="search_form" id="search_form">
              <div class="box-tools">
                <input type="hidden" name="category" id="category" value="4">
                <div class="input-group" style="width: 99%;height:300px">
                  <textarea name="category_text" id="category_text"  style="width:100%;height:100%" placeholder="카테고리"><?php echo $data['category_text'];?></textarea>
                </div>
              </form>
              </div>            
              </div>            
...
function saveForm() {
    var category_text = $('#category_text').val();
    var data = {mode:"save",category:"4",category_text:category_text};
    $.ajax({
		type:"POST",
		url:"/admin/ajax/category_save.php",
		dataType:"json",
		data:data,
		success:function(data){
		    //console.log(data);
