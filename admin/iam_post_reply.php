...
<script>
    ...
    function go_post_list(){
        location.href = "iam_post.php";
    }
</script>
<style>
    .switch input {
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>콘텐츠답글관리<small>답글을 관리합니다.</small></h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">콘텐츠답글관리</li>
            </ol>
        </section>
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12" style="padding-bottom:20px">
                    <button class="btn btn-primary pull-right" style="margin-right: 5px;" onclick="go_post_list();return false;"><i class="fa"></i> 콘텐츠댓글관리</button>
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT SQL_CALC_FOUND_ROWS r.*,p.content,m.mem_name,mem_phone,cont.idx,cont.contents_title ,cont.westory_card_url,site_iam from Gn_Iam_Contents cont
                                              inner join Gn_Iam_Post p on p.content_idx = cont.idx
                                              inner join Gn_Iam_Post_Response r on r.post_idx = p.id
                                              inner join Gn_Member m on m.mem_id = r.mem_id
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" name="show_content" value="<?=$row['contents']?>"/>
                                        </td>
                                        <td><?=$row['reg_date']?></td>
                                        <td>
