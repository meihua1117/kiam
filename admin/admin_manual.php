                ...
                <section class="content">
                    <div class="row"  id="toolbox">
                        ...
                        <?if($_SESSION['one_member_admin_id'] != "onlyonemaket"){?>
                            ...
                            <button class="btn btn-primary pull-right" style="margin-right: 5px;" onclick="location='/cliente_list.php?status=5'"><i class="fa fa-download"></i> 매뉴얼 보기</button>
                        <? }?>
                    ...
                    <div class="row">
                        <div class="box">
                            <div class="box-body">
                                ...
                                $query = "SELECT SQL_CALC_FOUND_ROWS * FROM tjd_board WHERE 1=1 and category=5 $searchStr";
                                ...
                                ?>
                                    <tr>
                                        <td><?=$number--?></td>
                                        <td><a href="manual_write.php?no=<?php echo $row['no']?>"><?php echo $row['title'];?></a></td>
