        ...
        <div class="m_body">
                ...
                <? if ($coach_apply_count > 0) { ?>
                    ...
                    <div>
                        <div class="p1">
                            ...
                            <input class="search_text" type="text" name="search_text" placeholder="검색값: 수강생이름,날짜,제목,내용,파일명" id="search_text" value="<?= $_REQUEST['search_text'] ?>" />
                            ...
                            <div style="float:right">
                                ...
                                ?>
                                    ...
                                    <select id="coty_info_select_id" style="height:35px;">
                                        ...
                                        ?>
                                                <option value="<?= $coaching_data["coty_id"] ?>_<?= $coach_id ?>_<?= $coaching_data["mem_name"] ?>_<?= $coaching_data["mem_code"] ?>"><?= $coaching_data["mem_id"] ?> / <?= $coaching_data["mem_name"] ?></option>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content animated bounceInRight">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-md-3" style="font-size: 16px;">수강평가</div>
                                                                <div class="col-md-9">
                                                                    <input type="email" class="coty_value_input form-control" placeholder="1=훌륭해요 2=좋았어요 3=괜찮아요 4=보완해요 5=대안필요" value="<?= $coaching_info_data['coty_value'] ?>" <? if ($coaching_info_data['coty_comment'] != "") {
                                                                                                                                                                                                                                    echo "disabled";
                                                                                                                                                                                                                                } ?>>
                                                                </div>
                                                            ...
                                                            <? } ?>
                                                            <div class="row">
                                                                <div class="col-md-3" style="font-size: 16px;">수강생의견</div>
                                                                <div class="col-md-9">
                                                                    <input type="email" class="coty_comment_input form-control" value="<?= $coaching_info_data['coty_comment'] ?>" <? if ($coaching_info_data['coty_comment'] != "") {
                                                                                                                                                                                        echo "disabled";
                                                                                                                                                                                    } ?>>
                                                                </div>
                                                            </div>
            ...
            <? if ($coaching_apply_count == 0 && $coach_apply_count == 0) { ?>
                <div style="text-align: center; font-size: 16px;margin-top: 20px;">
                    코치신청 자격을 담당자에게 확인해주세요. 수강신청은 누구나 할수 있습니다.
                </div>
...
<script type="text/javascript">
    ...
    function onCoachServiceNotAllow() {
        showMessageModal("신청 오류", "<p>신청자격이 없으므로 자격을 획득한 후에 신청해주세요.</p>");
    }
    ...
    function onCotyApply() {
        ...
        switch (coaching_type) {
            case "1":
                cont_term = 5;
                cont_time = 1;
                coaching_price = 110000;
                break;
            case "2":
                cont_term = 10;
                cont_time = 2;
                coaching_price = 209000;
                break;
            case "3":
                cont_term = 15;
                cont_time = 3;
                coaching_price = 308000;
                break;
            case "4":
                cont_term = 20;
                cont_time = 4;
                coaching_price = 407000;
                break;
            case "5":
                cont_term = 25;
                cont_time = 5;
                coaching_price = 506000;
                break;
            case "6":
                cont_term = 30;
                cont_time = 6;
                coaching_price = 605000;
                break;
            case "7":
                cont_term = 35;
                cont_time = 7;
                coaching_price = 704000;
                break;
            case "8":
                cont_term = 40;
                cont_time = 8;
                coaching_price = 893000;
                break;
            default:
        ...
        $.ajax({
            ...
            url: "/mypage.proc.php",
            data: {
                mode: "create_coaching_apply",
                cont_time: cont_time,
                cont_term: cont_term,
                coaching_price: coaching_price,
                coaching_want: coaching_want
            },
            dataType: 'html',
            success: function(data) {
                ...
                showMessageModal("신청 성공", "<h4>고객님, 수강신청이 접수되었습다.<h4> <p>계좌안내 : SC제일은행 617-20-197207 온리원연구소 송조은 <br/><br/> 위의 계좌로 코칭비용을 입금하시면 담당코치 배정 후 연락드리겠습니다. </p>");
    ...
    function onCotyComment(coaching_id) {
        ...
        $.ajax({
            ...
            url: "/mypage.proc.php",
            data: {
                mode: "update_coaching_info_coty_comment",
                coty_value: coty_value_input,
                coty_comment: coty_comment_input,
    ...
    function disabledCoachAlert() {
        showMessageModal("오류", "<p>아직 코칭승인이 되지 않았습니다. 담당자와 상담해 주세요.</p>");
    }
</script>
                ...
                <div>
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td style="color:#00a1d4;">수강생이름</td>
                                <td id="modal_coty_name"></td>
                                <td style="color:#00a1d4;">수강생ID</td>
                                <td id="modal_coty_id"></td>
                            </tr>
                            <tr>
                                <td style="color:#00a1d4;">전화번호</td>
                                <td id="modal_coty_phone"></td>
                                <td style="color:#00a1d4;">이메일</td>
                                <td id="modal_coty_email"></td>
                            </tr>
                            <tr>
                                <td style="color:#00a1d4;">계약기간</td>
                                <td id="modal_coty_cont_term"></td>
                                <td style="color:#00a1d4;">계약시간</td>
                                <td id="modal_coty_cont_time"></td>
                            </tr>

                            <tr>
                                <td style="color:#00a1d4;">코칭비용</td>
                                <td id="modal_coty_coaching_price"></td>
                                <td style="color:#00a1d4;">희망코칭</td>
                                <td id="modal_coty_want_coaching"></td>
                            </tr>
                            <tr>
                                <td style="color:#00a1d4;">코칭시작</td>
                                <td id="modal_coty_coaching_start_date" style="color:red;"></td>
                                <td style="color:#00a1d4;">코칭종료</td>
                                <td id="modal_coty_coaching_end_date" style="color:red;"></td>
                            </tr>
                            <tr>
                                <td style="color:#00a1d4;">진행상태</td>
                                <td id="modal_coty_coaching_status"></td>
                                <td style="color:#00a1d4;">코칭회차</td>
                                <td id="modal_coty_coaching_turn"></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<div class="modal fade" id="modal-alert">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title">IAM플랫폼코치신청하기</h4>
            </div>
            <div class="modal-body">
                <div class="alert alert-success m-b-0">
                    <h4>IAM플랫폼 코치신청하기</h4>
                    <p>IAM플랫폼의 코치로 활동하시겠습니까?</p>
                </div>
            </div>
            <div class="modal-footer" style="text-align: center;">
                <!--
...
<div class="modal fade" id="modal-coty-apply">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title">수강신청하기</h4>
            </div>
            <div class="modal-body">
                <div class="alert alert-success m-b-0">
                    <h4>코칭관리시스템 안내</h4>
                    <p>- 본 시스템은 코치가 수강생의 학습에 기여한 시간 즉, 화상회의, 전화상담, 카톡상담, 현장미팅 등에 대해 측정합니다.<br>


                        - 수강생은 영상이나 매뉴얼 등을 통해 셀프학습을 하고 문의 상담 토의를 화상 혹은 전화 카톡 등을 통해 학습하여 최대한 코치의 시간을 덜 사용하는 방향으로 하여 비용을 절약하시기바랍니다. <br>
                        - 유효기간이란 코칭을 시작한 날로부터 유효기간 이내에 해당 시간을 모두 사용해야합니다. 유효기간이 지나면 코칭시간이 남았어도 코칭계약이 마감되므로 꼭 유효기간 내에 이용 바랍니다. <br>
                        - 코칭 신청하기를 하신 후에 해당 비용(부가세 포함)을 아래 계좌로 입금하시기 바랍니다.<br>
                ...
                <div>
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>협의</td>
                                <td>협의</td>
                                <td><input type="radio" name="coaching_type" value="9"></td>
                            </tr>
                    ...
                    <tr>
                        <td>코칭비용 송금처</td>
                        <td>SC제일은행 617-20-197207 온리원연구소 송조은</td>
                    </tr>
                </div>
