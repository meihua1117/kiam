                        ...
                        <div class="p1">
                            ...
                            <div style="float:right">
                                ...
                                <input type="button" value="코칭정보입력" class="btn btn-success" <?
                                                                            ...
                                                                            ?> style="display: none;" onclick="disabledCoachAlert()" <?
                                                                                            }
                                                                                    ?>>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content animated bounceInRight">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-md-3" style="font-size: 16px;">코티평가</div>
                                                                <div class="col-md-9">
                                                            ...
                                                            <? } ?>
                                                            <div class="row">
                                                                <div class="col-md-3" style="font-size: 16px;">코티의견</div>
                                                                <div class="col-md-9">
                ...
                <div>
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td style="color:#00a1d4;">코티이름</td>
                                <td id="modal_coty_name"></td>
                                <td style="color:#00a1d4;">코티ID</td>
