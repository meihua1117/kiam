            ...
            <div class="m_body">
                <form name="pay_form" action="" method="post" class="my_pay">
                    ...
                    <div class="a1" style="margin-top:50px; margin-bottom:15px">
                        <li style="float:left;">
                            <div class="popup_holder popup_text">신청고객 리스트관리
                                <div class="popupbox" style="height: 56px;width: 215px;left: 180px;top: -37px;display:none">이벤트 신청창을 통해 신청한 데이터를 조회하는 기능입니다.<br><br>
                        ...
                        <div>
                            <table class="list_table" width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td style="width:10%">스탭문자<br>회차/발송건수</td>
                                ...
                                ?>
                                        <tr>
                                            <td><input type="checkbox" class="check" name="event_idx" value="<?php echo $row['request_idx']; ?>" data-name="<?= $row['name'] ?>" data-mobile="<?= $row['mobile'] ?>" data-email="<?= $row['email'] ?>" data-job="<?= $row['job'] ?>" data-event_code="<?= $row['event_code'] ?>" data-counsult_date="<?= $row['consult_date'] ?>" data-sp="<?= $row['sp'] ?>" data-request_idx="<?php echo $row['request_idx']; ?>"></td>
                                            <td><?= $sort_no ?></td>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="height:35px;text-align:left;">
                                        ...
                                        <input type="button" value="고객신청창 조회" class="button " id="searchEventBtn">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
