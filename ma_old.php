...
<script>
    ...
    if(window.location.host  == "gscfceo.kiam.kr"){
	alert("경기중소기업CEO연합회 회원사의 회원가입 및 로그인 안내\n"+
		"환영합니다.\n"+
        	"본 플랫폼은 CEO연합회 회원사를 위한 자동화 마케팅 및 고객관리 플랫폼입니다.\n"+
                "본 플랫폼을 이용하실 분은 아래와 같은 로그인 지침을 확인하시기바랍니다.\n"+
                "1. 연합회 회원사는 gscf.kr에서 회원가입한 경우 아래처럼 로그인해주세요\n"+
                "- http://gscf.kr 홈피의 아이디에 'ceo_'를 앞에 붙이고 임시비번 123456으로 로그인하여 비번 변경을 하시면 됩니다.\n"+
                "- 본 플랫폼을 이용하시기 위해서는 gscf.kr에 접속하여 먼저 회원가입해주세요.\n"+
                "- 휴대폰에서 아래 주소를 클릭하여 앱설치를 하시기바랍니다.\n"+
                "    https://me2.do/xVB4OHoO\n"+
                "2. 본 플랫폼을 활용하시기 위해서는 아래 이용안내 영상을 보시고활용해주세요.\n"+
                "    https://me2.do/IDFIAJMO\n"+
                "3. 본 플랫폼 이용중 문의 사항은 아래 카톡상담창으로 남겨주세요\n"+
