...
$GLOBALS['js_include_once'][] = 'db_structure.js';
$GLOBALS['js_include_once'][] = 'tbl_change.js';
$GLOBALS['js_include_once'][] = 'jquery/timepicker.js';
$GLOBALS['js_include_once'][] = 'jquery/jquery.sprintf.js';
...
if (empty($is_info)) {
    ...
    if ((!empty($submit_mult) && isset($selected_tbl))
        ...
        if (! isset($error) || false === $error) {
            include_once './libraries/mult_submits.inc.php';
        }
        if (empty($message)) {
...
if ($num_tables == 0) {
    ...
    if (empty($db_is_information_schema)) {
        include_once './libraries/display_create_table.lib.php';
