...
class PMA_Error extends PMA_Message
{
     ...
     * if $function is one of include_once/require the $arg is converted te relative path
     *
     * @param string $arg
    ...
    protected function displayArg($arg, $function)
    {
        ...
        if (in_array($function, $include_once_functions)) {
