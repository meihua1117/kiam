...
abstract class PMA_List extends ArrayObject
{
     ...
     * @param boolean $include_once_information_schema
     * @return  string  HTML option tags
     */
    public function getHtmlOptions($selected = '', $include_once_information_schema = true)
    {
        if (true === $selected) {
        ...
        foreach ($this as $each_item) {
            if (false === $include_once_information_schema
