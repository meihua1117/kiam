...
if (isset($plugin_list)) {
    ...
    // Append the bfShapeFiles directory to the include_once path variable
    set_include_once_path(get_include_once_path() . PATH_SEPARATOR . getcwd() . '/libraries/bfShapeFiles/');
