...
class PMA_User_Schema
{
    ...
    */
     ...
     * call and include_once the appropriate Schema Class depending on $export_type
     *
     * @return void
     * @access private
     */
    private function _processExportSchema()
    {
        ...
        */
        ...
        include_once "./libraries/schema/" . ucfirst($export_type) . "_Relation_Schema.class.php";
