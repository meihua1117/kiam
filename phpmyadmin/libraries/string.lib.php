...
if (@function_exists('mb_strlen')) {
    ...
    include_once './libraries/string_mb.lib.php';
} else {
    include_once './libraries/string_native.lib.php';
}
...
if (@extension_loaded('ctype')) {
    include_once './libraries/string_type_ctype.lib.php';
} else {
    include_once './libraries/string_type_native.lib.php';
}
