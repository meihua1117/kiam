...
/**
 * Allows phpMyAdmin to be include_onced from a document located on
...
/**
 * Whether to include_once comments in SQL export.
 *
 * @global string $cfg['Export']['sql_include_once_comments']
 */
$cfg['Export']['sql_include_once_comments'] = true;
 ...
 * Be sure to include_once no trailing slash on the path.
