...
/**
 * Removes insecure parts in a path; used before include_once() or
...
function PMA_fatalError($error_message, $message_args = null)
{
    ...
    include_once './libraries/error.inc.php';
 ...
 *
 * @param string $filename Filename to include_once in headers if empty,
 *                         none Content-Disposition header will be sent.
 * @param string $mimetype MIME type to include_once in headers.
 * @param int    $length   Length of content (optional)
 * @param bool   $no_cache Whether to include_once no-caching headers.
 *
 * @return nothing
 */
...
/**
 * Returns HTML code to include_once javascript file.
 *
 * @param string $url Location of javascript, relative to js/ folder.
 *
 * @return string HTML code for javascript inclusion.
 */
function PMA_include_onceJS($url)
{
    if (strpos($url, '?') === false) {
