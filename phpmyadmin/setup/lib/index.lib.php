...
function perform_config_checks()
{
    ...
    $strServerAuthConfigMsg = __('You set the [kbd]config[/kbd] authentication type and include_onced username and password for auto-login, which is not a desirable option for live hosts. Anyone who knows or guesses your phpMyAdmin URL can directly access your phpMyAdmin panel. Set %sauthentication type%s to [kbd]cookie[/kbd] or [kbd]http[/kbd].');
