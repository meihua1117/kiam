 ...
 *          that returns 0 rows - to prevent cyclic redirects or include_onces
 * @package PhpMyAdmin
 */
...
$GLOBALS['js_include_once'][] = 'tbl_structure.js';
$GLOBALS['js_include_once'][] = 'indexes.js';
$GLOBALS['js_include_once'][] = 'gis_data_editor.js';
...
if (isset($btnDrop) && $btnDrop == __('No')) {
    ...
    if ($is_gotofile) {
        ...
        $active_page = $goto;
        include_once './' . PMA_securePath($goto);
    } else {
...
if ((0 == $num_rows && 0 == $unlim_num_rows) || $is_affected) {
    ...
    if ($is_gotofile) {
        ...
        include_once 'libraries/db_table_exists.lib.php';
