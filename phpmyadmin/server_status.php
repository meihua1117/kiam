...
if (isset($_REQUEST['ajax_request']) && $_REQUEST['ajax_request'] == true) {
    ...
    if (isset($_REQUEST['advisor'])) {
        include_once 'libraries/Advisor.class.php';
        $advisor = new Advisor();
...
$GLOBALS['js_include_once'][] = 'server_status.js';
$GLOBALS['js_include_once'][] = 'jquery/jquery-ui-1.8.16.custom.js';
$GLOBALS['js_include_once'][] = 'jquery/jquery.tablesorter.js';
$GLOBALS['js_include_once'][] = 'jquery/jquery.cookie.js'; // For tab persistence
// Charting
$GLOBALS['js_include_once'][] = 'highcharts/highcharts.js';
/* Files required for chart exporting */
$GLOBALS['js_include_once'][] = 'highcharts/exporting.js';
/* < IE 9 doesn't support canvas natively */
if (PMA_USR_BROWSER_AGENT == 'IE' && PMA_USR_BROWSER_VER < 9) {
    $GLOBALS['js_include_once'][] = 'canvg/flashcanvas.js';
}
$GLOBALS['js_include_once'][] = 'canvg/canvg.js';
// for profiling chart
$GLOBALS['js_include_once'][] = 'jqplot/jquery.jqplot.js';
$GLOBALS['js_include_once'][] = 'jqplot/plugins/jqplot.pieRenderer.js';
...
if (PMA_DRIZZLE) {
    ...
    // admin commands are not queries (e.g. they include_once COM_PING,
...
function printQueryStatistics()
{
    ...
    foreach ($used_queries as $name => $value) {
        ...
        // but is include_onced in Questions. Then the total of the percentages is 100.
