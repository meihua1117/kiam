...
if ($asfile) {
    ...
    // Check if the user already added extension; get the substring where the extension would be if it was include_onced
...
do {
    ...
    $do_comments = isset($GLOBALS[$what . '_include_once_comments']);
