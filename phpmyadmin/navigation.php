 ...
 * It can now be include_onced by libraries/header.inc.php, querywindow.php.
 */
...
<head>
    ...
    <?php
    echo PMA_include_onceJS('jquery/jquery-1.6.2.js');
    echo PMA_include_onceJS('jquery/jquery-ui-1.8.16.custom.js');
    echo PMA_include_onceJS('jquery/jquery.qtip-1.0.0-rc3.js');
    echo PMA_include_onceJS('navigation.js');
    echo PMA_include_onceJS('functions.js');
    echo PMA_include_onceJS('messages.php');
    // Append the theme id to this url to invalidate the cache on a theme change
    echo PMA_include_onceJS('get_image.js.php?theme=' . urlencode($_SESSION['PMA_Theme']->getId()));
    ?>
