...
<div class="big_sub">
                ...
                <div>
                    <div class="p1">
                        <table class="list_table1" width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <th class="w200">강의제목</th>
                                <td><input type="text" name="lecture_info" placeholder="유투브 제목처럼 참여동기를 높이게 입력하세요" id="lecture_info" value="<?= $row['lecture_info'] ?>" /> </td>
                            </tr>
                            <tr>
                                <th class="w200">랜딩URL</th>
                                <td><input type="text" name="lecture_url" placeholder="홍보전용에서는 유투브강연주소를 입력하세요" id="lecture_url" value="<?= $row['lecture_url'] ?>" /> </td>
                            </tr>
                            <tr>
                                <th class="w200">강사이름</th>
                                <td><input type="text" name="instructor" placeholder="" id="instructor" value="<?= $row['instructor'] ?>" /> </td>
                            </tr>
                            <tr>
                                <th class="w200">지역/장소</th>
                                <td><input type="text" name="area" placeholder="현장은 주소와 공간위치를 입력하고 원격은 원격프로그램을 입력하세요 " id="area" value="<?= $row['area'] ?>" /> </td>
                            </tr>
                            <tr>
                                <th class="w200">참여대상</th>
                                <td><input type="text" name="target" placeholder="참여직업, 업종, 형태 등을 콤마로 나누어 입력하세요" id="target" value="<?= $row['target'] ?>" /> </td>
                            </tr>
                            <tr>
                                <th class="w200">정원</th>
                            ...
                            <?php if ($lecture_id != "") { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($row['review_img1']) {
                                            echo "<img src='/upload/lecture/" . $row['review_img1'] . "' style='height:80px'>";
                                            echo "<input type = 'button'  onclick='review_img_del_clicked(" . $row['lecture_id'] . ", 1)' value='이미지 삭제'>";
                                        } ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($row['review_img2']) {
                                            echo "<img src='/upload/lecture/" . $row['review_img2'] . "' style='height:80px'>";
                                            echo "<input type = 'button'  onclick='review_img_del_clicked(" . $row['lecture_id'] . ", 2)' value='이미지 삭제'>";
                                        } ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($row['review_img3']) {
                                            echo "<img src='/upload/lecture/" . $row['review_img3'] . "' style='height:80px'>";
                                            echo "<input type = 'button'  onclick='review_img_del_clicked(" . $row['lecture_id'] . ", 3)' value='이미지 삭제'>";
                                        } ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($row['review_img4']) {
                                            echo "<img src='/upload/lecture/" . $row['review_img4'] . "' style='height:80px'>";
                                            echo "<input type = 'button'  onclick='review_img_del_clicked(" . $row['lecture_id'] . ", 4)' value='이미지 삭제'>";
                                        } ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($row['review_img5']) {
                                            echo "<img src='/upload/lecture/" . $row['review_img5'] . "' style='height:80px'>";
                                            echo "<input type = 'button'  onclick='review_img_del_clicked(" . $row['lecture_id'] . ", 5)' value='이미지 삭제'>";
                                        } ?>
    ...
    <script>
        ...
        $(function() {
            ...
            $('.review_img_del').on("click", function() {
                alert(1);
            });
        ...
        function review_img_del_clicked(id, no) {
            $.ajax({
                type: "POST",
                url: "mypage.proc.php",
                data: {
