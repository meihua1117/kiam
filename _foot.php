...
<? } else { ?>
    <div class="m_div foot_2">
        <div>사이트명:온리원플랫폼 &nbsp; 회사명:(주)온리원셀링 &nbsp;공급사:온리원연구소 &nbsp; 사업자번호:119-86-03213 &nbsp; 대표:송조은 &nbsp; 주소:충청북도 영동군 용화면 민주지산로 765
            ...
            <!--<a href="http://pf.kakao.com/_jVafC/chat">카카오상담</a>/<a href="/onebook_serch.php?status=1" target="_blank"> &nbsp; 고객센터</a>이용시간:10:00-18:00(12:00~13:00 점심시간)-->&nbsp; Copyright©온리원셀링.All Rights Reserved. 호스팅: (주)카페24
        </div>
    </div>
<? }
        ...
        <ul>
            ...
            <li class="menu-item">
                ...
                <ul class="submenu">
                    ...
                    <li class="submenu-item"><a href="https://play.google.com/store/apps/details?id=mms.onepagebook.com.onlyonesms&pli=1" target="_blank">아이엠설치</a></li>
                </ul>
            </li>
