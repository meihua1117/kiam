   ...
   <div class="m_div">
       ...
       <div class="m_body">
        ...
        <div class="a1" style="margin-top:50px; margin-bottom:15px">
			<li style="float:left;">
				<div class="popup_holder popup_text"> 랜딩페이지
					<div class="popupbox" style="display:none; height: 75px;width: 250px;color: black;left: 105px;top: -37px;">자신의 이벤트 상품이나 서비스를 소개하거나 상세페이지로 만든 랜딩페이지를 리스트로 보는 기능입니다<br><br>
					<a class = "detail_view" style="color: blue;" href="https://url.kr/qhOex5" target="_blank">[자세히 보기]</a>
					</div>
				</div>				
			</li>
            ...
            <div class="p1">
                ...
                <div style="text-align:right;margin-top:0px;float:right;display: flex;">
                    ...
                    <div class="popup_holder"> <!--Parent-->
						...
						<div class="popupbox" style="display:none; height: 63px;width: 180px;bottom: 37px; display:none;">자신의 이벤트 상품이나 서비스를 소개하거나 상세페이지로 보여줄수 있도록 제작하는 기능입니다.<br><br><!--Child-->
						  <a class = "detail_view" style="color: blue;" href="https://url.kr/MtZKlg" target="_blank">[자세히 보기]</a>
						</div>
					</div>
					<div class="popup_holder"> <!--Parent-->
						<input type="button" value="전체삭제" class="button" onclick="removeAll()" style="cursor: pointer">
					</div>
                </div>
            </div>
		...
		?>   
              <?
                  ...
                  ?>
              <tr>
                <td><input type="checkbox" name="land_idx" value="<?=$row['landing_idx'];?>"></td>
                <td><?=$sort_no?></td>
