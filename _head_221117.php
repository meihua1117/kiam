<?
    ...
    $sql = "select * from tjd_pay_result where buyer_id='$_SESSION[one_member_id]' and end_date > '$date_today' and end_status in ('Y','A')  and 
        ((member_type like '%standard%' or member_type like '%professional%' or member_type like '%enterprise%') or 
        (((iam_pay_type = '' or iam_pay_type = '0' or iam_pay_type = '전문가') and member_type != '포인트충전')) or member_type='베스트상품') order by end_date desc";
    $res_result = mysql_query($sql);
    $pay_data = mysql_fetch_array($res_result);
    //$rights = 0;
    $mem_sql = "select mem_type,site_iam, iam_type from Gn_Member where mem_id='$_SESSION[one_member_id]'";
    $mem_res = mysql_query($mem_sql);
    $mem_row = mysql_fetch_array($mem_res);
    $mem_type = $mem_row['mem_type'];
    $site = $mem_row[site_iam];
    $iam_type = $mem_row[iam_type];
    if($site){
        if($site == "kiam")
...
<?if($HTTP_HOST !== "dbstar.kiam.kr" && $HTTP_HOST !== "mts.kiam.kr" && $HTTP_HOST !== "kookmin.kiam.kr" && $HTTP_HOST !== "election.kiam.kr" && $HTTP_HOST !== "onemunja.kiam.kr") {?>
    <div class="ad_header">
        ...
        do{ ?>
            ...
            <?$i++;}while($ad_data = mysql_fetch_array($res_result));?>
    ...
    <header class="big_h_f" id="header">
        <div class="h_div" style="background-color: #24303e;">
            ...
            <?}
                ...
                <style>
                    .header-gnb { position: relative; padding-bottom: 20px; left: 5%;}
                    .header-gnb:after {content: '';position: absolute; top: 38px; left: 50%; width: 100vw; height: 0px; background-color: #fff; opacity: 0; visibility: hidden; z-index: 1;
                    -webkit-box-shadow: 0 5px 5px rgba(0,0,0,0.15);
                    box-shadow: 0 5px 5px rgba(0,0,0,0.15);
                    -webkit-transform: translateX(-50%);
                        ...
                        <ul>
                            ...
                            <li class="menu-item" id="msub2">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="submenu-item"><a href="/cliente_list.php?status=1&one_no=85%E2%80%8" >디버설치하기</a></li>
                            ...
                            <li class="menu-item" id="msub12">
                                ...
                                <ul class="submenu">
                                    <li class="submenu-item"><a href="/sub_12.php">스텝문자소개</a></li>
                                    ...
                                    <?php }else{?>
                                        ...
                                        <li class="submenu-item"><a href="/mypage_link_list.php">신청창관리</a></li>
                                        ...
                                        <li class="submenu-item"><a href="/mypage_oldrequest_list.php">기존고객발송</a></li>
                            ...
                            <li class="menu-item">
                                <a href="http://www.smsallline.com/home/login" target="_balnk">국제문자</a></li>
                        </ul>
                    </div>
                </nav><!-- // Menu GNB -->
            <?}
                ...
                <nav class="header-gnb" ><!-- Menu GNB -->
                    <div class="gnb-container" style="text-align:center;font-size:100px;">
                        <ul>
                            ...
                            <li class="menu-item" id="msms">
                                <a href="http://www.moonjaok.com/main.do" target="_balnk">웹문자</a>
                            </li>
                            <li class="menu-item">
                                <a href="http://www.smsallline.com/home/login" target="_balnk">국제문자</a>
                            </li>
	...
	<div class="big_1 head_breadcrumb" style="display:none;width:100%;position:absolute;">
		...
		<div class="m_head_div" id="sub10" style="position:relative;">
			...
			<div style="position:absolute;left:200px;">
                ...
                <a href="https://tinyurl.com/557nca2b" target="_blank">아이엠매뉴얼</a> |
                <?
                $sql_chk = "select count(a.mem_code) as cnt from Gn_Member a inner join Gn_Iam_Service b on a.mem_id=b.mem_id where a.service_type>=1 and a.mem_id='{$_SESSION[one_member_id]}'";
        ...
        <div class="m_head_div" id="sub2" style="position:relative;">
			...
			<div style="position:absolute;left:320px;">
                ...
                <a href="/cliente_list.php?status=1&one_no=85%E2%80%8">디버설치하기</a> |
		...
		<div class="m_head_div" id="sub12">
            ...
            <div class="right_sub_menu">&nbsp;
                ...
                <?if($pay_data[onestep1] != "ON" && $iam_type != 2){ ?>
                    <a onclick="alert('결제 후 사용가능합니다.');">랜딩페이지</a> |
                    <a onclick="alert('결제 후 사용가능합니다.');">고객신청창</a> |
                    <a onclick="alert('결제 후 사용가능합니다.');">스텝예약관리</a> |
                    <a onclick="alert('결제 후 사용가능합니다.');">데일리발송</a> |
                    <a onclick="alert('결제 후 사용가능합니다.');">신청고객관리</a> |
        ...
        <div class="m_head_div" id="sms" style="position:relative;">
            <div class="left_sub_menu">
                <a href="./">홈</a> >
                <a href="http://www.moonjaok.com/main.do">웹문자</a> >
            </div>
