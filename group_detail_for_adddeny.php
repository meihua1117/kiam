...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div style="text-align: center;">
            ...
            <button onclick="window.close()" class="btn_adddeny">확인</button>
        </div>
        <script>
            function box_ed_deny(g,name){
                var name_arr = document.getElementsByName('name_box');
                var group_arr = [];
                console.log(opener.$('#deny_num_multi').val());
                if (opener.$('#deny_num_multi').val())
                    group_arr = opener.$('#deny_num_multi').val().split(",");
                ...
                opener.$('#deny_num_multi').val(group_arr.join(","));
                opener.$('#deny_num_multi').focus();
            }
        </script>
    </body>
</html>
