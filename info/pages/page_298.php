...
<link rel="stylesheet" href="/pages/auto_data/saved/page_298.css?r=0311170221" type="text/css">
...
<link rel="stylesheet" href="/pages/auto_data/saved/module_873.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_1007.css?r=0311170221" type="text/css">
...
<body id="menu_group_53" class="menu_id_298 menu_order_01">
...
<h2 id="locwrap_1006"><span class="loctt_1006"><img src="/image_bank/icon/dot/head_symbol_9.gif" class="vmiddle">&nbsp;</span><a href="/pages/page_295.php?" class="lochm_1006">Home</a><span class="locsp_1006">></span><span class="loccr_1006">회원정보 수정</span></h2></div>
<h2 id="locwrap_903"><span class="loccr_903">회원정보 수정</span></h2></div>
<div id="cell_120_157">
<?php
$module_id=873;
...
<h2 id="vmenu_1007_head">스쿨-마이페이지</h2>
<ul id="vmenu_1007" class="drop_gnb_v">
<li id="vmenu_1007_298" depth="1" num="0" class="on"><a href="/pages/page_298.php" class="vmenu_depth_1 active">회원정보 수정</a></li>
<li id="vmenu_1007_299" depth="1" num="0"><a href="/pages/page_299.php" class="vmenu_depth_1">회원 탈퇴</a></li>
</ul>
<script type="text/javascript">
jQuery(document).ready(function($) {
	$('#vmenu_1007 ul').css('display','none');
	$('#vmenu_1007 a.active').next('ul').css('display','block');

	
	$('<li class="noLava"><div class="menu_line"></div></li>').insertBefore($('#vmenu_1007>li[num]:gt(0)'));
