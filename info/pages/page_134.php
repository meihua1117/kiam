...
$connect=dbconn();
@access_right_chk(1, '', '');
$ui_og_arr=@print_board_title('오시는길', '', '', '');
...
<link rel="stylesheet" href="/pages/auto_data/saved/page_134.css?r=0311170221" type="text/css">
...
<link rel="stylesheet" href="/pages/auto_data/saved/module_306.css?r=0311170221" type="text/css">
...
<body id="menu_group_21" class="menu_id_134 menu_order_01">
...
<div id="cell_0_15">
<div id="cell_15_14">
<ul id="hmenu_353" class="drop_gnb pulldown_menu float_clear" direct=""><li id="hmenu_353_112" depth="1" num="0" style="width:25%;" class="on"><a href="/pages/page_132.php" class="active">회사소개</a></li>
...
<li id="vmenu_265_112" depth="1" num="0" class="on"><a href="/pages/page_132.php" class="vmenu_depth_1 active">회사소개</a>
<ul>
...
<li id="vmenu_265_134" depth="2" class="on"><a href="/pages/page_134.php" class="vmenu_depth_2 active">오시는길</a></li>
</ul>
</li>
...
<div id="cell_15_18">
<h2 id="locwrap_266"><a href="/pages/page_75.php?" class="lochm_266">Home</a><span class="locsp_266">></span><a href="/pages/page_132.php" class="locmn_266">회사소개</a><span class="locsp_266">></span><span class="loccr_266">오시는길</span></h2></div>
<div id="cell_15_19">
<div id="googlemap_306"></div>
<script type="text/javascript">
jQuery(document).ready(function() {
	googlemap_maker('googlemap_306',{latitude:37.5316834,longitude:126.9696924,zoom:15,maptype:'ROADMAP',maph:'',width:200,content:"<b>Title</b><br />02-555-555",show:1,control:true,bounce:1});
});
</script>
</div>
</div>
