...
$ui_og_arr=@print_board_title('Home', '', 'http://3key.co.kr/image_bank/dummy/fskin_12/logo.png', '');
...
<link rel="stylesheet" href="/pages/auto_data/saved/page_1085.css?r=0311170221" type="text/css">
...
<link rel="stylesheet" href="/pages/auto_data/saved/module_5236.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_5220.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_5197.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_5227.css?r=0311170221" type="text/css">
...
<body id="menu_group_137" class="menu_id_1085 menu_order_01">
...
<div id="cell_14_16">
<ul id="hmenu_5177" class="drop_gnb pulldown_menu float_clear" direct=""><li id="hmenu_5177_1106" depth="1" num="0"><a href="/pages/page_1107.php">회사소개</a>
<ul>
<li id="hmenu_5177_1107" depth="2"><a href="/pages/page_1107.php">CEO 인사말</a></li>
...
<div id="cell_2_23">
<div id="cell_23_26">
<div id="notice_5236"><div class="smartOutput"><h1 style="text-align: center;"><span style="color: rgb(255, 255, 255);">WELCOME TO URBANIC</span></h1>

<p style="text-align: center;"><span style="color: rgb(230, 230, 250);">CHOOSE THE ONE SUITABLE FOR YOU</span></p>

<p style="text-align: center;"><a class="ozbutton orange normal rounded" href="/pages/page_26.php" role="button" style="margin: 20px;"><span style="color: rgb(255, 255, 255);"><u>View Demo</u></span></a> <a class="ozbutton green normal rounded" href="/pages/page_34.php" role="button"><span style="color: rgb(255, 255, 255);"><u>Free Download</u></span></a></p>
</div>
<div class="smartOutput"><h1 style="text-align: center;"><span style="color: rgb(255, 255, 255);">RESPONSIVE LAYOUT</span></h1>

<p style="text-align: center;"><span style="color: rgb(255, 255, 255);">This template is free to download and use for any website.</span></p>

<p style="text-align: center;"><span style="color: rgb(255, 255, 255);">This is a mobile-ready layout using Bootstrap framework.</span></p>

<p style="text-align: center;">&nbsp;</p>

<p style="text-align: center;"><a class="ozbutton orange normal rounded" href="/pages/page_23.php" role="button"><span style="color: rgb(255, 255, 255);"><u>Read More</u></span></a></p>
</div>
<div class="smartOutput"><h1 style="text-align: center;"><span style="color: rgb(255, 255, 255);">FLUID</span></h1>

<p style="text-align: center;"><span style="color: rgb(255, 255, 255);">Suspendisse pellentesque,</span></p>

<p style="text-align: center;"><span style="color: rgb(255, 255, 255);">odio vel ultricies interdum,</span></p>

<p style="text-align: center;"><span style="color: rgb(255, 255, 255);">mauris nulla ullamcorper magna,</span></p>

<p style="text-align: center;"><span style="color: rgb(255, 255, 255);">non aliquet odio velit aliquam augue.</span></p>
</div>
</div>
<a class="notice_prev_5236" id="notice_prev_5236" href="#"><span>prev</span></a><a class="notice_next_5236" id="notice_next_5236" href="#"><span>next</span></a><div class="notice_pag_5236" id="notice_pag_5236"></div><script type="text/javascript">
var $cell_id_5236;
jQuery(document).ready(function($) {
$('#notice_5236').css('display','block');
$cell_id_5236=$('#notice_5236').parent();
$('#notice_5236>div').css({'float':'left'});
jQuery(window).bind('load resize', img6_carou_5236);
img6_carou_5236();
function img6_carou_5236() {
	var width=$cell_id_5236.width();
	if(width==0) return;
	$('#notice_5236>div').css({'width':width});
	$('#notice_5236').carouFredSel({
		direction:'left',
		items:{visible:1},
		scroll:{items:1,pauseOnHover:'immediate',fx:'scroll',easing:'swing',duration:500,timeoutDuration:5000},
						prev:{button:'#notice_prev_5236', key:'left'},
		next:{button:'#notice_next_5236', key:'right'},
						pagination:"#notice_pag_5236",
				auto:{play:true}
	});
}
$('#notice_prev_5236').click(function() {$('#notice_5236').trigger('configuration', {'direction':'right'});});
$('#notice_next_5236').click(function() {$('#notice_5236').trigger('configuration', {'direction':'left'});});
});
</script>
</div>
</div>
<div id="cell_2_6">
<div id="cell_6_7">
<div class="smartOutput float_clear"><p style="text-align: center;"><span style="font-size: 38px;"><span class="txt_darkgrey">Welcome to </span><span style="color: rgb(230, 126, 34);"><span class="txt_orange">Urbanic Design</span></span></span></p>

<p class="txt_slogan" style="text-align: center;"><span style="color: rgb(169, 169, 169);"><span style="font-size: 13px;"><i>Lorem ipsum dolor sit amet, consect adipiscing elit. Etiam metus libero mauriec ignissim fermentum.</i></span></span></p>
</div>
</div>
<div id="cell_6_8" class="float_clear">
<article><div id="cell_8_24">
<?php
$module_id=5197;
$cell_id='cell_8_24';
