...
$connect=dbconn();
@access_right_chk(1, '', '');
$ui_og_arr=@print_board_title('채용정보', '', '', '');
...
<link rel="stylesheet" href="/pages/auto_data/saved/page_114.css?r=0311170221" type="text/css">
...
<body id="menu_group_21" class="menu_id_114 menu_order_03">
...
<div id="cell_15_18">
<h2 id="locwrap_266"><a href="/pages/page_75.php?" class="lochm_266">Home</a><span class="locsp_266">></span><span class="loccr_266">채용정보</span></h2></div>
<div id="cell_15_19">
</div>
</div>
<div id="cell_0_3">
