...
$connect=dbconn();
@access_right_chk(2, '/pages/page_37.php', '');
$ui_og_arr=@print_board_title('회원정보 수정', '', '', '');
...
<link rel="stylesheet" href="/pages/auto_data/saved/page_1129.css?r=0311170221" type="text/css">
...
<link rel="stylesheet" href="/pages/auto_data/saved/module_5290.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_5424.css?r=0311170221" type="text/css">
...
<body id="menu_group_145" class="menu_id_1129 menu_order_01">
...
<div id="cell_124_149">
<h2 id="locwrap_5423"><span class="loctt_5423"><img src="/image_bank/dummy/fskin_177/icon_home.gif" class="vmiddle">&nbsp;</span><a href="/pages/page_1126.php?" class="lochm_5423">Home</a><span class="locsp_5423">></span><span class="loccr_5423">회원정보 수정</span></h2></div>
<div id="cell_124_130">
<h2 id="locwrap_5320"><span class="loccr_5320">회원정보 수정</span></h2></div>
<div id="cell_124_131">
<article><?php
$module_id=5290;
$cell_id='cell_124_131';
@include_once '/home/hosting_users/ilearning1/www/cgi_bank/member/info_1.php';
?>
</article></div>
</div>
<div id="cell_120_123" class="col-xs-12 col-sm-3  row">
<div id="cell_123_128" class="hidden-xs">
<h2 id="vmenu_5424_head">서경련-마이페이지</h2>
<ul id="vmenu_5424" class="drop_gnb_v">
<li id="vmenu_5424_1129" depth="1" num="0" class="on"><a href="/pages/page_1129.php" class="vmenu_depth_1 active">회원정보 수정</a></li>
<li id="vmenu_5424_1130" depth="1" num="0"><a href="/pages/page_1130.php" class="vmenu_depth_1">회원 탈퇴</a></li>
</ul>
<script type="text/javascript">
jQuery(document).ready(function($) {
	$('#vmenu_5424 ul').css('display','none');
	$('#vmenu_5424 a.active').next('ul').css('display','block');

	
	$('<li class="noLava"><div class="menu_line"></div></li>').insertBefore($('#vmenu_5424>li[num]:gt(0)'));
