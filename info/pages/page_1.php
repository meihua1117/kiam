...
$ui_og_arr=@print_board_title('3key.co.kr', '', '', '');
...
<link rel="stylesheet" href="/pages/auto_data/saved/page_1.css?r=0311170221" type="text/css">
...
<link rel="stylesheet" href="/pages/auto_data/saved/module_167.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_362.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_366.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_359.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_365.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_367.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_368.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_374.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_370.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_384.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_369.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_376.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_372.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_371.css?r=0311170221" type="text/css">
...
<body id="menu_group_2" class="menu_id_1 menu_order_01">
...
$module_id=5114;
$cell_id='cell_0_151';
@include_once '/home/hosting_users/ilearning1/www/cgi_bank/popup/popup_1.php';
?>
</div>
<div id="cell_0_133">
...
<div id="cell_0_137">
<?
include_once '/home/hosting_users/ilearning1/www/pages/auto_data/saved/module_167.inc';
?>
</div>
<div id="cell_0_172">
<div id="cell_172_173">
<div id="cell_173_175">
<table id="table_175_179" class="wiz_column" cellpadding="0" cellspacing="0"><tr class="tcell">
<td id="td_175_179"><div class="td_wrapper">
<span class="banner_text_362">온리원창</span><script type="text/javascript">$(function() {$(".banner_text_362").ozfontresize({fontSize:50,baseWidth:322});})</script></div></td>
<td id="td_175_180"><div class="td_wrapper">
<?
include_once '/home/hosting_users/ilearning1/www/pages/auto_data/saved/module_363.inc';
?>
</div></td>
</tr></table>
</div>
...
<div id="cell_204_218">
<?
include_once '/home/hosting_users/ilearning1/www/pages/auto_data/saved/module_366.inc';
?>
</div>
</div>
</div>
...
<div id="cell_155_156">
<?
include_once '/home/hosting_users/ilearning1/www/pages/auto_data/saved/module_359.inc';
?>
</div>
</div>
</div>
...
<div id="cell_188_205">
<?
include_once '/home/hosting_users/ilearning1/www/pages/auto_data/saved/module_365.inc';
?>
</div>
</div>
<div id="cell_172_189">
<div id="cell_189_203">
<div id="notice_367"><ul class="notice_367"><li><div class="each_item"><div class="keep_ratio"><div class="keep_ratio_box"><img src="/data_user/user/reneefree.jpg" border="0" class="notice_thumb oz_zoom" zimg="/data_user/user/reneefree.jpg" alt="이효정"></div></div><h3><a>이효정</a></h3></div></li><li><div class="each_item"><div class="keep_ratio"><div class="keep_ratio_box"><img src="/data_user/user/gwunki001.jpg" border="0" class="notice_thumb oz_zoom" zimg="/data_user/user/gwunki001.jpg" alt="권인화"></div></div><h3><a>권인화</a></h3></div></li><li><div class="each_item"><div class="keep_ratio"><div class="keep_ratio_box"><img src="/data_user/lecture/20160425.jpg" border="0" class="notice_thumb oz_zoom" zimg="/data_user/lecture/20160425.jpg" alt="온리원3.0"></div></div><h3><a>온리원3.0</a></h3></div></li><li><div class="each_item"><div class="keep_ratio"><div class="keep_ratio_box"><img src="/data_user/lecture/s_160529.jpg" border="0" class="notice_thumb oz_zoom" zimg="/data_user/lecture/s_160529.jpg" alt="인성3차원모델"></div></div><h3><a>인성3차원모델</a></h3></div></li></ul></div>
<script type="text/javascript">
var $cell_id_367;
jQuery(document).ready(function($) {
$cell_id_367=$('#notice_367').parent();
});
jQuery(window).load(function() {

});
jQuery(document).ready(function($){setInterval(function(){if($cell_id_367.width()<800){$(".notice_367 li").css("width","50%");}else if($cell_id_367.width()<1200){$(".notice_367 li").css("width","25%");}else{$(".notice_367 li").css("width","25%");}},100);});jQuery(window).load(function(){setTimeout(function(){jQuery(".notice_367").masonry({itemSelector:"li"});},200);});</script>
</div>
</div>
<div id="cell_172_190">
<div id="cell_190_206">
<?
include_once '/home/hosting_users/ilearning1/www/pages/auto_data/saved/module_368.inc';
?>
</div>
</div>
<div id="cell_172_191">
<div id="cell_191_209">
<div id="notice_374"><ul class="notice_374"><li><div class="each_item"><div class="keep_ratio"><div class="keep_ratio_box"><img src="/data_user/lecture/2012_07_30_10.16.22.jpg" border="0" class="notice_thumb oz_zoom" zimg="/data_user/lecture/2012_07_30_10.16.22.jpg" alt="온리원강연"></div></div><h3><a>온리원강연</a></h3></div></li><li><div class="each_item"><div class="keep_ratio"><div class="keep_ratio_box"><img src="/data_user/lecture/00.jpg" border="0" class="notice_thumb oz_zoom" zimg="/data_user/lecture/00.jpg" alt="온리원교재"></div></div><h3><a>온리원교재</a></h3></div></li><li><div class="each_item"><div class="keep_ratio"><div class="keep_ratio_box"><img src="/data_user/lecture/1.jpg" border="0" class="notice_thumb oz_zoom" zimg="/data_user/lecture/1.jpg" alt="온리원친구"></div></div><h3><a>온리원친구</a></h3></div></li><li><div class="each_item"><div class="keep_ratio"><div class="keep_ratio_box"><img src="/data_user/lecture/joseph.jpg" border="0" class="notice_thumb oz_zoom" zimg="/data_user/lecture/joseph.jpg" alt="온리원강사"></div></div><h3><a>온리원강사</a></h3></div></li></ul></div>
<script type="text/javascript">
var $cell_id_374;
jQuery(document).ready(function($) {
$cell_id_374=$('#notice_374').parent();
});
jQuery(window).load(function() {

});
jQuery(document).ready(function($){setInterval(function(){if($cell_id_374.width()<800){$(".notice_374 li").css("width","50%");}else if($cell_id_374.width()<1200){$(".notice_374 li").css("width","25%");}else{$(".notice_374 li").css("width","25%");}},100);});jQuery(window).load(function(){setTimeout(function(){jQuery(".notice_374").masonry({itemSelector:"li"});},200);});</script>
</div>
</div>
<div id="cell_172_192">
<div id="cell_192_207">
<?
include_once '/home/hosting_users/ilearning1/www/pages/auto_data/saved/module_370.inc';
?>
</div>
</div>
<div id="cell_172_193">
...
<div id="cell_194_208">
<?
include_once '/home/hosting_users/ilearning1/www/pages/auto_data/saved/module_369.inc';
?>
</div>
</div>
<div id="cell_172_195">
...
<?php
$module_id=376;
$cell_id='cell_195_211';
@include_once '/home/hosting_users/ilearning1/www/cgi_bank/notice/notice_3.php';
?>
</div>
</div>
<div id="cell_172_196">
<div id="cell_196_212" class="float_clear row">
<div id="cell_212_223" class="col-xs-12 col-sm-12 col-lg-6">
<div id="cell_223_225">
<?php
$module_id=372;
$cell_id='cell_223_225';
@include_once '/home/hosting_users/ilearning1/www/cgi_bank/notice/notice_2.php';
?>
</div>
</div>
<div id="cell_212_220" class="col-xs-12 col-sm-12 col-lg-6">
<div id="cell_220_222">
<?php
$module_id=371;
$cell_id='cell_220_222';
@include_once '/home/hosting_users/ilearning1/www/cgi_bank/notice/notice_2.php';
?>
</div>
</div>
