...
<link rel="stylesheet" href="/pages/auto_data/saved/page_4.css?r=0311170221" type="text/css">
...
<link rel="stylesheet" href="/pages/auto_data/saved/module_32.css?r=0311170221" type="text/css">
<link rel="stylesheet" href="/pages/auto_data/saved/module_166.css?r=0311170221" type="text/css">
...
<body id="menu_group_3" class="menu_id_4 menu_order_01">
...
<h2 id="locwrap_165"><span class="loctt_165"><img src="/image_bank/icon/dot/head_symbol_9.gif" class="vmiddle">&nbsp;</span><a href="/pages/page_1.php?" class="lochm_165">Home</a><span class="locsp_165">></span><span class="loccr_165">회원정보 수정</span></h2></div>
<h2 id="locwrap_62"><span class="loccr_62">회원정보 수정</span></h2></div>
<div id="cell_120_157">
<?php
$module_id=32;
...
<h2 id="vmenu_166_head">edu-마이페이지</h2>
<ul id="vmenu_166" class="drop_gnb_v">
<li id="vmenu_166_4" depth="1" num="0" class="on"><a href="/pages/page_4.php" class="vmenu_depth_1 active">회원정보 수정</a></li>
<li id="vmenu_166_5" depth="1" num="0"><a href="/pages/page_5.php" class="vmenu_depth_1">회원 탈퇴</a></li>
</ul>
<script type="text/javascript">
jQuery(document).ready(function($) {
	$('#vmenu_166 ul').css('display','none');
	$('#vmenu_166 a.active').next('ul').css('display','block');

	
	$('<li class="noLava"><div class="menu_line"></div></li>').insertBefore($('#vmenu_166>li[num]:gt(0)'));
