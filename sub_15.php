   ...
   <a name="Introduce"></a>
    ...
    <div class="bnt main-buttons" style="background-color: #0B610B;padding-bottom:20px;">
      <div class="wrap2" style="max-width: 849px; margin: 0 auto;">
        ...
        <a href="https://oog.kiam.kr/pages/page_3209.php" class="button" target="_blank" >온리원디버 이용매뉴얼</a>
      
        <a href="<?=$domainData['kakao'];?>" class="button2" target="_blank">카카오상담하기</a>
        <a href="https://oog.kiam.kr/pages/page_3215.php" class="button" target="_blank">FAQ</a>
      </div>
    </div>
    <?php }else{?>
