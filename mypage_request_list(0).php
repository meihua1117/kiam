                        ...
                        <li style="float:left;">
                            <div class="popup_holder popup_text">신청고객 리스트관리
                                <div class="popupbox" style="height: 56px;width: 215px;left: 180px;top: -37px;display:none">이벤트 신청창을 통해 신청한 데이터를 조회하는 기능입니다.<br><br>
                                    <a class = "detail_view" style="color: blue;" href="https://url.kr/1bHgsA" target="_blank">[자세히 보기]</a>
                                </div>
                            </div>
                        </li>
                                    ...
                                    <td>
                                        <?
                                            if($row_event_data['sms_idx1'] != 0)
                                            {
                                                ...
                                                $res = mysql_query($sql);
                                                $send_row = mysql_fetch_array($res);
                                    ...
                                    <td>
                                        <div class="popup_holder popup_text">신청정보
                                            ...
                                            [신청정보보기]<br>
                                                ...
                                                &nbsp;>생일:<? echo " $row[birthday]";?><br>
                                                &nbsp;>소속/직업:<? echo " $row[job]";?><br>
                                                &nbsp;>메일:<? echo " $row[email]";?><br>
                                                &nbsp;>주소:<? echo " $row[addr]";?><br>
                                                &nbsp;>가입:<? echo " $row[join_yn]";?><br>
                                                &nbsp;>기타:<? echo " $row[consult_date]";?><br>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
