...
function set_service_mem_cnt($mem_id, $mem_cnt)
{
	...
	$sql_res = "insert into Gn_Item_Pay_Result set buyer_id='{$mem_id}', buyer_tel='{$row_data['mem_phone']}', item_name='씨드포인트충전', item_price=1000000, pay_percent=90, current_point={$row_data['mem_point']}, current_cash={$row_data['mem_cash']}, pay_status='Y', VACT_InputName='{$row_data['mem_name']}', type='buy', seller_id='{$mem_id}', pay_method='결제씨드충전', pay_date=now(), point_val=1,billdate=now()";
