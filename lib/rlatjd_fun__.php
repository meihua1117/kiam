...
$cdn_ssl = "http://test.kiam.kr";
$kiam_ssl = "http://test.kiam.kr";
...
function message_send($to,$subject,$content,$return_msg){
    /******************** 인증정보 ********************/
...
function sendmms($type, $userid, $sendnum, $recvnum, $rserv_time, $title, $content, $img, $img1, $img2, $send_agreement_yn, $sms_idx="", $sms_detail_idx="", $request_idx="", $gd_id="", $send_deny_msg="", $or_id="")
{
	...
	curl_setopt($ch_mms, CURLOPT_URL, "http://kiam.kr/ajax/heineken.php");
